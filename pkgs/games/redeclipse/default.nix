{ stdenv, fetchFromGitHub, fetchurl, fetchpatch, curl, ed, pkgconfig, zlib, libX11, SDL2, SDL2_image, SDL2_mixer
}:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/red-eclipse/base/releases/download/v${version}/redeclipse_${version}_nix.tar.bz2";
    sha256 = "0j98zk7nivdsap4y50dlqnql17hdila1ikvps6vicwaqb3l4gaa8";
  };

  buildInputs = [ libX11 zlib SDL2 SDL2_image SDL2_mixer ];

  nativeBuildInputs = [ curl ed pkgconfig ];
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/red-eclipse/base/commit/b16b4963c1ad81bb9ef784bc4913a4c8ab5f1bb4.diff";
