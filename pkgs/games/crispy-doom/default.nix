...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/fabiangreffrath/crispy-doom/archive/${name}.tar.gz";
  ...
  meta = {
    ...
    longDescription = ''
      Crispy Doom is a limit-removing enhanced-resolution Doom source port based on Chocolate Doom. Its name means that 640x400 looks "crisp" and is also a slight reference to its origin.'';
