...
# manager site.
{ stdenv, fetchurl, factorio-utils, allRecommendedMods ? true, allOptionalMods ?
  false }:
with stdenv.lib;
let
  modDrv =
...
in rec {
  ...
  bobassembly = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobassembly_0.13.0.zip" ];
  ...
  bobconfig = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobconfig_0.13.1.zip" ];
  ...
  bobelectronics = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobelectronics_0.13.1.zip" ];
  ...
  bobenemies = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobenemies_0.13.1.zip" ];
  ...
  bobgreenhouse = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobgreenhouse_0.13.2.zip" ];
  ...
  bobinserters = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobinserters_0.13.3.zip" ];
  ...
  boblibrary = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/boblibrary_0.13.1.zip" ];
  ...
  boblogistics = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/boblogistics_0.13.7.zip" ];
  ...
  bobmining = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobmining_0.13.1.zip" ];
  ...
  bobmodules = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobmodules_0.13.0.zip" ];
  ...
  bobores = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobores_0.13.1.zip" ];
  ...
  bobplates = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobplates_0.13.2.zip" ];
  ...
  bobpower = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobpower_0.13.1.zip" ];
  ...
  bobrevamp = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobrevamp_0.13.0.zip" ];
  ...
  bobtech = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobtech_0.13.0.zip" ];
  ...
  bobtechsave = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobtechsave_0.13.0.zip" ];
  ...
  bobwarfare = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/bobwarfare_0.13.4.zip" ];
  ...
  clock = modDrv {
    src = fetchurl {
      urls = [ "https://f.xor.us/factorio-mods/clock_0.13.0.zip" ];
