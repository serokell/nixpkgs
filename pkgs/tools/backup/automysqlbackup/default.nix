...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "mirror://sourceforge/automysqlbackup/AutoMySQLBackup/AutoMySQLBackup%20VER%203.0/automysqlbackup-v${version}.tar.gz";
  ...
  installPhase = ''
    ...
    wrapProgram $out/bin/automysqlbackup --prefix PATH : ${
      stdenv.lib.makeBinPath [ mysql mailutils pbzip2 pigz bzip2 gzip ]
    }
  '';
