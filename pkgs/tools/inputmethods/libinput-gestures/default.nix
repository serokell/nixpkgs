{ lib, stdenv, fetchFromGitHub, makeWrapper, libinput, wmctrl, python3, xdotool ?
  null, extraUtilsPath ? lib.optional (xdotool != null) xdotool }:
stdenv.mkDerivation rec {
  ...
  patches = [ ./0001-hardcode-name.patch ./0002-paths.patch ];
  ...
  postFixup = ''
    ...
    wrapProgram "$out/bin/libinput-gestures" --prefix PATH : "${
      lib.makeBinPath extraUtilsPath
    }"
  '';
