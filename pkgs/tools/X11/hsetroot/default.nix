...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://mirror.datapipe.net/gentoo/distfiles/hsetroot-${version}.tar.gz";
  ...
  underlinkingPatch = fetchurl {
    url =
      "http://www.gtlib.gatech.edu/pub/gentoo/gentoo-x86-portage/x11-misc/hsetroot/files/hsetroot-1.0.2-underlinking.patch";
