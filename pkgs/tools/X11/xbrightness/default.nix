{ stdenv, fetchurl, imake, gccmakedep, libX11, libXaw, libXext, libXmu, libXpm, libXxf86vm
}:
...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url =
      "https://shallowsky.com/software/xbrightness/xbrightness-0.3-mika-akk.tar.gz";
