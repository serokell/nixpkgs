{ lib, python, groff, less, fetchpatch }:
    ...
    packageOverrides = self: super: {
      rsa = super.rsa.overridePythonAttrs (oldAttrs: rec {
        ...
        src = oldAttrs.src.override {
          inherit version;
          sha256 =
            "25df4e10c263fb88b5ace923dd84bf9aa7f5019687b5e55382ffcdb8bede9db5";
        };
      });
      ...
      pyyaml = super.pyyaml.overridePythonAttrs (oldAttrs: rec {
        ...
        patches = lib.singleton (fetchpatch {
          url =
            "https://github.com/yaml/pyyaml/commit/c5b135fe39d41cffbdc006f28ccb2032df6005e0.patch";
...
in py.pkgs.buildPythonApplication rec {
  pname = "awscli";
  version =
    "1.16.170"; # N.B: if you change this, change botocore to a matching version too
