...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url =
      "https://github.com/svanderburg/dysnomia/files/1756700/dysnomia-0.8.tar.gz";
    sha256 = "0pc4zwmmlsz02a6a4srpwdwhqrfvn3wkn22sz3fg7lwxbdbd5k0z";
  };

  preConfigure =
    if enableEjabberdDump then "export PATH=$PATH:${ejabberd}/sbin" else "";
  ...
  buildInputs = [ getopt ] ++ stdenv.lib.optional enableEjabberdDump ejabberd
