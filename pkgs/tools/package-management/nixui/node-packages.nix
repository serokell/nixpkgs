...
let
  sources = {
    ...
    "binary-search-tree-0.2.4" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/binary-search-tree/-/binary-search-tree-0.2.4.tgz";
...
in {
  "nixui-git://github.com/matejc/nixui.git#0.2.1" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      sha256 =
        "2a2b1dcd9201e306242688c6c86f520ac47ef5de841ae0d7ea6ae8ff2889c3ab";
    };
    dependencies = [
      sources."async-0.2.10"
      (sources."binary-search-tree-0.2.4" // {
        dependencies = [ sources."underscore-1.4.4" ];
      })
