...
stdenv.mkDerivation rec {
  ...
  src = if hpnSupport then
    fetchurl {
      url =
        "https://github.com/rapier1/openssh-portable/archive/hpn-KitchenSink-7_8_P1.tar.gz";
  ...
  buildInputs = [ zlib openssl libedit pam ] ++ optional withKerberos kerberos
  ...
  configureFlags = [
    ...
    (assert kerberos != null; "--with-kerberos5=${kerberos}")
