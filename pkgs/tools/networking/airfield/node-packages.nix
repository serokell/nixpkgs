...
let
  sources = {
    ...
    "buffer-crc32-0.1.1" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/buffer-crc32/-/buffer-crc32-0.1.1.tgz";
    ...
    "cookie-signature-0.0.1" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/cookie-signature/-/cookie-signature-0.0.1.tgz";
    ...
    "range-parser-0.0.4" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/range-parser/-/range-parser-0.0.4.tgz";
    ...
    "redis-commands-1.5.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/redis-commands/-/redis-commands-1.5.0.tgz";
        sha512 =
          "6KxamqpZ468MeQC3bkWmCB1fp56XL64D4Kf0zJSwDZbVLLm7KFkoIcHrgRvQ+sk8dnhySs7+yBg94yIkAK7aJg==";
      };
    };
    "redis-parser-2.6.0" = {
      name = "redis-parser";
...
in {
  ...
  connect-redis = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/connect-redis/-/connect-redis-3.4.1.tgz";
      sha512 =
        "oXNcpLg/PJ6G4gbhyGwrQK9mUQTKYa2aEnOH9kWIxbNUjIFPqUmzz75RdLp5JTPSjrBVcz+9ll4sSxfvlW0ZLA==";
    };
    dependencies = [
      sources."debug-4.1.1"
      sources."double-ended-queue-2.1.0-0"
  ...
  async = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 =
        "ZswD8vwPtmBZzbn9xyi8XBQWXH3AvOQ43Za1KWYq7JeycrZuUYzx01KvHcVbXltjqH4y0MWrQ33008uLTqXuDw==";
    };
    buildInputs = globalBuildInputs;
    meta = {
      description =
