...
let
  ...
  sha256 = {
    ...
    "system #{stdenv.hostPlatform.system.} is not supported");

  url = {
    "x86_64-linux" =
      "http://kindlegen.s3.amazonaws.com/kindlegen_linux_2.6_i386_v${fileVersion}.tar.gz";
    "i686-linux" =
      "http://kindlegen.s3.amazonaws.com/kindlegen_linux_2.6_i386_v${fileVersion}.tar.gz";
    "x86_64-darwin" =
      "http://kindlegen.s3.amazonaws.com/KindleGen_Mac_i386_v${fileVersion}.zip";
    "i686-darwin" =
      "http://kindlegen.s3.amazonaws.com/KindleGen_Mac_i386_v${fileVersion}.zip";
    "x86_64-cygwin" =
      "http://kindlegen.s3.amazonaws.com/kindlegen_win32_v${fileVersion}.zip";
    "i686-cygwin" =
      "http://kindlegen.s3.amazonaws.com/kindlegen_win32_v${fileVersion}.zip";
  }."${stdenv.hostPlatform.system}" or (throw
    "system #{stdenv.hostPlatform.system.} is not supported");
...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    stdenv.lib.optional (stdenv.lib.hasSuffix ".zip" url) unzip;
