...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://http.debian.net/debian/pool/main/f/fakeroot/fakeroot_${version}.orig.tar.xz";
  ...
  patches = stdenv.lib.optional stdenv.isLinux ./einval.patch
    ...
    ++ stdenv.lib.optionals stdenv.isDarwin [
      ...
      (fetchpatch {
        ...
        url =
          "https://bugs.debian.org/cgi-bin/bugreport.cgi?att=2;bug=766649;filename=fakeroot-always-pass-mode.patch;msg=20";
