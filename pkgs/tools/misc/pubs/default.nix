...
python3Packages.buildPythonApplication rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/pubs/pubs/pull/185/commits/e58ae98b93b8364a07fd5f5f452ba88ad332c948.patch";
      sha256 = "1n7zrk119v395jj8wqg8wlymc9l9pq3v752yy3kam9kflc0aashp";
    })
    # Fix test broken by PyYAML 5.1
    (fetchpatch {
      url =
        "https://github.com/pubs/pubs/pull/194/commits/c3cb713ae76528eeeaaeb948fe319a76ab3934d8.patch";
