...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://s3.amazonaws.com/scanse/Visualizer/v${version}/sweepvisualizer_${version}_amd64.deb";
  ...
  meta = with stdenv.lib; {
    homepage =
      "https://support.scanse.io/hc/en-us/articles/115006008948-Visualizer-Overview";
    description =
      "A minimal desktop application for interfacing with the Sweep device";
