...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://www.hdfgroup.org/ftp/HDF5/releases/HDF-JAVA/hdfjni-${version}/src/CMake-hdfjava-${version}.tar.gz";
  ...
  meta = {
    description =
      "A Java package that implements HDF4 and HDF5 data objects in an object-oriented form";
