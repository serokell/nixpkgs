...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://www.freedesktop.org/software/desktop-file-utils/releases/${name}.tar.xz";
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://gitlab.freedesktop.org/xdg/desktop-file-utils/commit/92af4108750ceaf4191fd54e255885c7d8a78b70.patch";
