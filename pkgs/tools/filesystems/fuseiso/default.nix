...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "mirror://sourceforge/project/fuseiso/fuseiso/20070708/fuseiso-20070708.tar.bz2";
  ...
  patches = let
    fetchPatchFromDebian = { patch, sha256 }:
      fetchpatch {
        inherit sha256;
        url =
          "https://sources.debian.net/data/main/f/fuseiso/20070708-3.2/debian/patches/${patch}";
      };
    in [
