{ stdenv, fetchurl, unzip, python, makeWrapper, ghostscript, pngnq, pillow, djvulibre, optipng, unrar
}:
...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    ...
    # Temporary place:
    url =
      "http://vicerveza.homeunix.net/~viric/soft/PDFRead-1.8.2-Source-noGUI-noInstaller.zip";
