...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/omapd/${name}.tgz";
  ...
  meta = with stdenv.lib; {
    ...
    description =
      "IF-MAP Server that implements the IF-MAP v1.1 and v2.0 specifications published by the Trusted Computing Group (TCG)";
