{ stdenv, fetchFromGitHub, libtool, autoreconfHook, pkgconfig, sysfsutils
...
, jitterentropy ? null, withJitterEntropy ? false, libp11 ? null, opensc ?
  null, withPkcs11 ? true }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ sysfsutils ] ++ optionals withGcrypt [ libgcrypt ]
