{ stdenv, fetchurl, gradle_2_5, perl, makeWrapper, jre, makeDesktopItem
, writeText, runtimeShell }:
...
let
  ...
  src = fetchurl {
    url =
      "https://github.com/java-decompiler/jd-gui/archive/v${version}.tar.gz";
