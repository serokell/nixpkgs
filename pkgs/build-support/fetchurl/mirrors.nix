rec {
  ...
  oldsuse = [ "ftp://ftp.gmd.de/ftp.suse.com-discontinued/" ];
  ...
  # MySQL mirrors
  mysql = [ "http://cdn.mysql.com/Downloads/" ];
  ...
  steamrt =
    [ "http://repo.steampowered.com/steamrt/" "https://abbradar.net/steamrt/" ];
  ...
  # Maven Central
  maven =
    [ "http://repo1.maven.org/maven2/" "http://central.maven.org/maven2/" ];
