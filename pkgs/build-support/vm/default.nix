  ...
  fillDiskWithRPMs =
    ...
    runInLinuxVM (stdenv.mkDerivation {
      ...
      buildCommand = ''
        ...
        ${utillinux}/bin/umount /mnt${storeDir} /mnt/tmp ${
  ...
  debDistros = rec {
    ...
    ubuntu1204i386 = {
      ...
      packagesLists = [
        ...
        (fetchurl {
          url =
            "mirror://ubuntu/dists/precise/universe/binary-i386/Packages.bz2";
    ...
    ubuntu1204x86_64 = {
      ...
      packagesLists = [
        ...
        (fetchurl {
          url =
            "mirror://ubuntu/dists/precise/universe/binary-amd64/Packages.bz2";
    ...
    ubuntu1710x86_64 = {
      ...
      packagesLists = [
        ...
        (fetchurl {
          url =
            "mirror://ubuntu/dists/artful/universe/binary-amd64/Packages.xz";
    ...
    debian9i386 = {
      ...
      packagesList = fetchurl {
        url =
          "http://snapshot.debian.org/archive/debian/20190503T090946Z/dists/stretch/main/binary-i386/Packages.xz";
    ...
    debian9x86_64 = {
      ...
      packagesList = fetchurl {
        url =
          "http://snapshot.debian.org/archive/debian/20190503T090946Z/dists/stretch/main/binary-amd64/Packages.xz";
