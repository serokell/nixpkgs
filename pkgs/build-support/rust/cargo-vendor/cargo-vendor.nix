...
in rec {
  crates = cratesIO // rec {
    ...
    crates.cargo_vendor."0.1.23" = deps:
      { features ? (features_.cargo_vendor."0.1.23" deps { }) }:
      buildRustCrate {
    ...
    features_.cargo_vendor."0.1.23" = deps: f:
      updateFeatures f (rec {
        cargo."${deps.cargo_vendor."0.1.23".cargo}".default = true;
        cargo_vendor."0.1.23".default =
          (f.cargo_vendor."0.1.23".default or true);
  ...
  __all = [ (cargo_vendor { }) ];
  deps.adler32."1.0.3" = { };
  deps.aho_corasick."0.7.3" = { memchr = "2.2.0"; };
  deps.ansi_term."0.11.0" = { winapi = "0.3.7"; };
  deps.atty."0.2.11" = {
    termion = "1.5.1";
    libc = "0.2.51";
    winapi = "0.3.7";
  ...
  deps.commoncrypto."0.2.0" = { commoncrypto_sys = "0.2.0"; };
  deps.commoncrypto_sys."0.2.0" = { libc = "0.2.51"; };
  ...
  deps.crc."1.8.1" = { build_const = "0.2.1"; };
  deps.crc32fast."1.2.0" = { cfg_if = "0.1.7"; };
  ...
  deps.itertools."0.7.11" = { either = "1.5.2"; };
  deps.itoa."0.4.3" = { };
  ...
  deps.lock_api."0.1.5" = { scopeguard = "0.3.3"; };
  deps.log."0.4.6" = { cfg_if = "0.1.7"; };
  deps.matches."0.1.8" = { };
  deps.matrixmultiply."0.1.15" = { rawpointer = "0.1.0"; };
  deps.memchr."2.2.0" = { };
  deps.miniz_sys."0.1.11" = {
    libc = "0.2.51";
    cc = "1.0.35";
  };
  deps.miniz_oxide."0.2.1" = { adler32 = "1.0.3"; };
  ...
  deps.num_complex."0.2.1" = { num_traits = "0.2.6"; };
  deps.num_traits."0.2.6" = { };
  deps.num_cpus."1.10.0" = { libc = "0.2.51"; };
  deps.once_cell."0.1.8" = { parking_lot = "0.7.1"; };
  deps.opener."0.3.2" = {
    failure = "0.1.5";
    failure_derive = "0.1.5";
    winapi = "0.3.7";
  ...
  deps.openssl_src."111.2.1+1.1.1b" = { cc = "1.0.35"; };
  ...
  deps.quote."0.6.12" = { proc_macro2 = "0.4.27"; };
  deps.rand."0.6.5" = {
    rand_chacha = "0.1.1";
    rand_core = "0.4.0";
    rand_hc = "0.1.0";
  ...
  deps.rand_hc."0.1.0" = { rand_core = "0.3.1"; };
  deps.rand_isaac."0.1.1" = { rand_core = "0.3.1"; };
  ...
  deps.rand_xorshift."0.1.1" = { rand_core = "0.3.1"; };
  deps.rawpointer."0.1.0" = { };
  deps.rdrand."0.4.0" = { rand_core = "0.3.1"; };
  deps.redox_syscall."0.1.54" = { };
  deps.redox_termios."0.1.1" = { redox_syscall = "0.1.54"; };
  deps.regex."1.1.6" = {
    aho_corasick = "0.7.3";
    memchr = "2.2.0";
    regex_syntax = "0.6.6";
  ...
  deps.regex_syntax."0.6.6" = { ucd_util = "0.1.3"; };
  deps.remove_dir_all."0.5.1" = { winapi = "0.3.7"; };
  ...
  deps.ryu."0.2.7" = { };
  deps.same_file."1.0.4" = { winapi_util = "0.1.2"; };
  ...
  deps.serde."1.0.90" = { serde_derive = "1.0.90"; };
  deps.serde_derive."1.0.90" = {
    proc_macro2 = "0.4.27";
    quote = "0.6.12";
    syn = "0.15.32";
  };
  deps.serde_ignored."0.0.4" = { serde = "1.0.90"; };
  ...
  deps.sized_chunks."0.1.3" = { typenum = "1.10.0"; };
  deps.smallvec."0.6.9" = { };
  deps.socket2."0.3.8" = {
    cfg_if = "0.1.7";
    libc = "0.2.51";
  ...
  deps.textwrap."0.11.0" = { unicode_width = "0.1.5"; };
  deps.thread_local."0.3.6" = { lazy_static = "1.3.0"; };
  deps.toml."0.4.10" = { serde = "1.0.90"; };
  deps.toml."0.5.0" = { serde = "1.0.90"; };
  deps.typenum."1.10.0" = { };
  deps.ucd_util."0.1.3" = { };
  ...
  deps.winapi_util."0.1.2" = { winapi = "0.3.7"; };
