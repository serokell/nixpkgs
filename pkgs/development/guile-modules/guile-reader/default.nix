{ stdenv, fetchurl, fetchpatch, pkgconfig, gperf, guile, guile-lib, libffi }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://download.savannah.nongnu.org/releases/guile-reader/${name}.tar.gz";
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/reader_flag.patch?h=guile-reader&id=63ac0413a1aa65eb6a0db57bc16ef4481b70dc31";
