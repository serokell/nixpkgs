  ...
  sources = {
    ...
    "npm-package-arg-6.1.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "zYbhP2k9DbJhA0Z3HKUePUgdB1x7MfIfKssC+WLPFMKTBZKpZh5m13PgexJjCq6KW7j17r0jHWcCpxEqnnncSA==";
      };
    };
    "npm-registry-client-8.6.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/npm-registry-client/-/npm-registry-client-8.6.0.tgz";
        sha512 =
          "Qs6P6nnopig+Y8gbzpeN/dkt+n7IyVd8f45NTMotGk6Qo7GfBmzwYx6jRLoOOgKiMnaQfYxsuyQlD8Mc3guBhg==";
      };
    };
    "npmconf-2.1.3" = {
      name = "npmconf";
      ...
      src = fetchurl {
        ...
        sha512 =
          "iTK+HI68GceCoGOHAQiJ/ik1iDfI7S+cgyG8A+PP18IU3X83kRhQIRhAUNj4Bp2JMx6Zrt5kCiozYa9uGWTjhA==";
      };
    };
    "npmlog-4.1.2" = {
      name = "npmlog";
    ...
    "semver-6.1.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "aymF+56WJJMyXQHcd4hlK4N75rwj5RQpfW8ePlQnJsTYOBLlLbcIErR/G1s9SkIvKBqOudR3KAx4wEqP+F1hNQ==";
      };
    };
    "set-blocking-2.0.0" = {
      name = "set-blocking";
    ...
    "walk-2.3.14" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "5skcWAUmySj6hkBdH6B6+3ddMjVQYH5Qy9QGbPmN8kVmLteXk+yVXg+yfk1nbX30EYakahLrr8iPcCxJQSCBeg==";
      };
    };
    "which-1.3.1" = {
      name = "which";
...
in {
  nijs = nodeEnv.buildNodePackage {
    ...
    dependencies = [ sources."optparse-1.0.5" sources."slasp-0.0.4" ];
  ...
  node2nix = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 =
        "p9lcFtr02Ryoo0FqNNGJ7lklDzVCT1vHHQ0Qg81SdbSQ+Ib4DwzAItJSy8EMwUvDdim1o9K3wMQljURxApvItg==";
    };
    dependencies = [
      sources."abbrev-1.1.1"
      sources."ajv-6.10.2"
      ...
      (sources."fs-extra-0.6.4" // {
        dependencies = [ sources."mkdirp-0.3.5" sources."rimraf-2.2.8" ];
      })
      ...
      (sources."normalize-package-data-2.5.0" // {
        dependencies = [ sources."semver-5.7.0" ];
      })
      ...
      (sources."npmconf-2.1.3" // {
        dependencies = [ sources."once-1.3.3" sources."semver-4.3.6" ];
      })
