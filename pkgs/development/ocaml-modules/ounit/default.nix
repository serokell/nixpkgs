...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url =
      "https://forge.ocamlcore.org/frs/download.php/1258/ounit-2.0.0.tar.gz";
  ...
  patches = with stdenv.lib;
    optional (versionAtLeast ocaml.version "4.02") (fetchpatch {
      url =
        "https://raw.githubusercontent.com/ocaml/opam-repository/master/packages/ounit/ounit.2.0.0/files/safe-string.patch";
