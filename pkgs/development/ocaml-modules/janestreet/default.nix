{ janePackage, ocamlbuild, angstrom, cryptokit, ctypes, magic-mime, ocaml-migrate-parsetree, octavius, ounit, ppx_deriving, re, num, openssl, ppxlib
}:
...
rec {
  ...
  ppx_expect = janePackage {
    ...
    propagatedBuildInputs =
      [ fieldslib ppx_compare ppx_inline_test ppx_sexp_conv ];
  ...
  core_kernel = janePackage {
    ...
    propagatedBuildInputs =
      [ configurator jane-street-headers sexplib splittable_random ];
  ...
  async_rpc_kernel = janePackage {
    ...
    propagatedBuildInputs =
      [ core_kernel async_kernel protocol_version_header ];
  ...
  email_message = janePackage {
    ...
    propagatedBuildInputs =
      [ async angstrom core_extended cryptokit magic-mime ounit ];
