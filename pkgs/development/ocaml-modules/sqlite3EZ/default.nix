...
if stdenv.lib.versionAtLeast ocaml.version "4.06" then
  throw "sqlite3EZ is not available for OCaml ${ocaml.version}"
else
  ...
  stdenv.mkDerivation {
    ...
    src = fetchurl {
      ...
      sha256 =
        "8ed2c5d5914a65cbd95589ef11bfb8b38a020eb850cdd49b8adce7ee3a563748";
    };
    ...
    meta = with stdenv.lib; {
      ...
      description =
        "A thin wrapper for sqlite3-ocaml with a simplified interface";
