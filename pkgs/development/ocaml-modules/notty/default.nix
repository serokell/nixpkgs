...
if !versionAtLeast ocaml.version "4.03" then
  throw "notty is not available for OCaml ${ocaml.version}"
else
  ...
  in stdenv.mkDerivation rec {
    ...
    propagatedBuildInputs = [ result uucp uuseg uutf ] ++ optional withLwt lwt;
