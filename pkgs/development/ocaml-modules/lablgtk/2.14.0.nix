...
, gtksourceview, camlp4 }:

if stdenv.lib.versionAtLeast ocaml.version "4.04" then
  throw "lablgtk-2.14 is not available for OCaml ${ocaml.version}"
else
  ...
  in stdenv.mkDerivation (rec {
    ...
    buildInputs =
      [ ocaml findlib gtk2 libgnomecanvas libglade gtksourceview camlp4 ];
    ...
    meta = {
      ...
      maintainers =
        [ stdenv.lib.maintainers.z77z stdenv.lib.maintainers.roconnor ];
