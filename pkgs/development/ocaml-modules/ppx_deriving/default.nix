...
if !stdenv.lib.versionAtLeast ocaml.version "4.02" then
  ...
  let
    param = if ocaml.version == "4.03.0" then {
      version = "4.1";
  ...
  in stdenv.mkDerivation rec {
    ...
    src = fetchzip {
      url =
        "https://github.com/ocaml-ppx/ppx_deriving/archive/v${version}.tar.gz";
    ...
    installPhase =
      "OCAMLPATH=$OCAMLPATH:`ocamlfind printconf destdir` make install";
