...
if stdenv.lib.versionAtLeast ocaml.version "4.03" then
  throw "mlgmp is not available for OCaml ${ocaml.version}"
else
  ...
  in stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      url =
        "http://www-verimag.imag.fr/~monniaux/download/${pname}_${version}.tar.gz";
      sha256 =
        "3ce1a53fa452ff5a9ba618864d3bc46ef32190b57202d1e996ca7df837ad4f24";
    };

    makeFlags = [ "DESTDIR=$(out)/lib/ocaml/${ocaml.version}/site-lib/gmp" ];
