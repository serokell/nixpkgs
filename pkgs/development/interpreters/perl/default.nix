...
let
  ...
  common = { perl, buildPerl, version, sha256 }:
    stdenv.mkDerivation (rec {
      ...
      patches = [
        ...
        (if (versionOlder version "5.29.6") then
      ...
      configureScript = stdenv.lib.optionalString (!crossCompiling)
      ...
      meta = {
        ...
        description =
          "The standard implementation of the Perl 5 programmming language";
