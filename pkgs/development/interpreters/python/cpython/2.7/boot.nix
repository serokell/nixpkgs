...
in stdenv.mkDerivation rec {
  ...
  configureFlags =
    [ "--enable-shared" "--with-threads" "--enable-unicode=ucs4" ]
  ...
  passthru.pkgs = builtins.throw
    "python-boot does not support packages, this package is only intended for bootstrapping."
    { };
