...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ autoconf213 pkgconfig perl which buildPackages.python2 zip ];
  ...
  NIX_CFLAGS_COMPILE =
    "-fno-delete-null-pointer-checks -fno-strict-aliasing -fno-tree-vrp";
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://git.archlinux.org/svntogit/packages.git/plain/trunk/mozjs52-disable-mozglue.patch?h=packages/js52&id=4279d2e18d9a44f6375f584911f63d13de7704be";
  ...
  makeFlags = [ "HOST_CC=${buildPackages.stdenv.cc}/bin/cc" ];
