{ stdenv, lib, autoconf213, fetchurl, fetchpatch, pkgconfig, nspr, perl, python2
, zip }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ pkgconfig ]
    ++ lib.optional stdenv.isAarch32 autoconf213;
  ...
  patches = [
    (fetchpatch {
      name = "gcc6.patch";
      url =
        "https://sources.debian.org/data/main/m/mozjs/1.8.5-1.0.0+dfsg-6/debian/patches/fix-811665.patch";
