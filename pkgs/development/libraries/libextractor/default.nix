...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://git.archlinux.org/svntogit/community.git/plain/trunk/libextractor-exiv2-0.27.patch?h=packages/libextractor&id=4dc53f7fc69210ae571285dface108ed65d8ee53";
  ...
  buildInputs =
    [ libtool gettext zlib bzip2 flac libvorbis exiv2 libgsf rpm pkgconfig ]
