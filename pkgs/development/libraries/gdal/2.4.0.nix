...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    ...
    patch -lp2 <${
      fetchpatch {
        url =
          "https://github.com/OSGeo/gdal/commit/29f4dfbcac2de718043f862166cd639ab578b552.diff";
    ...
    patch -p2 <${
      fetchpatch {
        url =
          "https://github.com/OSGeo/gdal/commit/19967e682738977e11e1d0336e0178882c39cad2.diff";
