{ stdenv, fetchurl, fetchpatch, pkgconfig, intltool, gobject-introspection
, gtk-doc, docbook_xsl, glib, libsoup, libxml2, libxslt, check, curl, perl
, hwdata, osinfo-db, vala ? null }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://gitlab.com/libosinfo/libosinfo/commit/3654abee6ead9f11f8bb9ba8fc71efd6fa4dabbc.patch";
      name = "CVE-2019-13313-1.patch";
      sha256 = "1lybywfj6b41zfjk33ap90bab5l84lf5y3kif7vd2b6wq5r91rcn";
    })
    (fetchpatch {
      url =
        "https://gitlab.com/libosinfo/libosinfo/commit/08fb8316b4ac42fe74c1fa5ca0ac593222cdf81a.patch";
