{ lib, stdenv, fetchFromGitHub, fetchpatch, cmake, pkgconfig, unzip, zlib, pcre, hdf5, glog, boost, google-gflags, protobuf, config
...
let
  ...
  ippicv = {
    ...
    files =
      let name = platform: "ippicv_2017u3_${platform}_general_20180518.tgz";
...
in stdenv.mkDerivation rec {
  ...
  patches = lib.optional stdenv.isDarwin (fetchpatch {
    url =
      "https://github.com/opencv/opencv/commit/7621b91769098359e893e68ad474040ca7940fa1.patch";
  ...
  buildInputs = [ zlib pcre hdf5 glog boost google-gflags ]
    ...
    ++ lib.optional enableTbb tbb ++ lib.optional enableCuda cudatoolkit
