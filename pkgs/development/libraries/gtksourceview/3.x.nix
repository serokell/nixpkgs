{ stdenv, fetchurl, pkgconfig, atk, cairo, glib, gtk3, pango, vala, libxml2, perl, intltool, gettext, gnome3, gobject-introspection, dbus, xvfb_run, shared-mime-info
}:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "mirror://gnome/sources/gtksourceview/${
