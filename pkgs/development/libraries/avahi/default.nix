...
stdenv.mkDerivation rec {
  name =
    "avahi${stdenv.lib.optionalString withLibdnssdCompat "-compat"}-${version}";
  version = "0.7";
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/lathiat/avahi/commit/e111def44a7df4624a4aa3f85fe98054bffb6b4f.patch";
  ...
  propagatedBuildInputs = stdenv.lib.optionals withPython
