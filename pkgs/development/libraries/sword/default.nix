...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://www.crosswire.org/ftpmirror/pub/sword/source/v1.7/${name}.tar.gz";
  ...
  patches = [
    (fetchurl {
      url =
        "https://gitweb.gentoo.org/repo/gentoo.git/plain/app-text/sword/files/sword-1.7.4-gcc6.patch";
