...
in stdenv.mkDerivation rec {
  ...
  patches = optionals (!stdenv.isDarwin) [
    (fetchpatch {
      ...
      url =
        "https://libvirt.org/git/?p=libvirt.git;a=patch;h=aed6a032cead4386472afb24b16196579e239580";
    ...
    (fetchpatch {
      ...
      url =
        "https://libvirt.org/git/?p=libvirt.git;a=patch;h=db0b78457f183e4c7ac45bc94de86044a1e2056a";
      sha256 = "17pd1rab2mxj4q0vg30vi2gh78mf52ik1p5l12wrghb0wjf7swml";
    })
    (fetchpatch {
      name = "5.4.0-CVE-2019-10167.patch";
      url =
        "https://libvirt.org/git/?p=libvirt.git;a=patch;h=8afa68bac0cf99d1f8aaa6566685c43c22622f26";
      sha256 = "0hgbwk0y2n6ihzjk8vqabhw914axjqgzcb7c5xx893r86c54c0ml";
    })
    (fetchpatch {
      name = "5.4.0-CVE-2019-10168.patch";
      url =
        "https://libvirt.org/git/?p=libvirt.git;a=patch;h=bf6c2830b6c338b1f5699b095df36f374777b291";
  ...
  preConfigure = ''
    ...
    PATH=${
      stdenv.lib.makeBinPath ([ dnsmasq ] ++ optionals stdenv.isLinux [
        iproute
        iptables
        ebtables
        lvm2
