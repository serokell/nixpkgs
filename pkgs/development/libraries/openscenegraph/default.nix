...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    ...
    pcre
    zlib
  ] ++ lib.optional jpegSupport libjpeg ++ lib.optional jasperSupport jasper
    ++ lib.optional exrSupport openexr ++ lib.optional gifSupport giflib
    ++ lib.optional pngSupport libpng ++ lib.optional tiffSupport libtiff
    ++ lib.optional gdalSupport gdal ++ lib.optional curlSupport curl
    ...
    ++ lib.optional sdlSupport SDL2 ++ lib.optionals restSupport [ asio boost ]
