{ enableX11 ? true, stdenv, fetchurl, pkgconfig, xorg }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://launchpad.net/frame/trunk/v${version}/+download/${name}.tar.xz";
    sha256 = "bc2a20cd3ac1e61fe0461bd3ee8cb250dbcc1fa511fad0686d267744e9c78f3a";
  };

  buildInputs = [ stdenv pkgconfig ] ++ stdenv.lib.optionals enableX11 [
    xorg.xorgserver
    xorg.libX11
    xorg.libXext
    xorg.libXi
