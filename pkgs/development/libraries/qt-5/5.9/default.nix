...
{ newScope, stdenv, fetchurl, fetchpatch, makeSetupHook, makeWrapper, bison, cups ?
  null, harfbuzz, libGL, perl, gstreamer, gst-plugins-base, gtk3, dconf,
  ...
  patches = {
    ...
    qtvirtualkeyboard = [
      (fetchpatch {
        ...
        url =
          "https://codereview.qt-project.org/gitweb?p=qt/qtvirtualkeyboard.git;a=patch;h=61780a113f02b3c62fb14516fe8ea47d91f9ed9a";
        sha256 = "0jd4nzaz9ndm9ryvrkav7kjs437l661288diklhbmgh249f8gki0";
      })
      (fetchpatch {
        name = "CVE-2018-19865-B.patch";
        url =
          "https://codereview.qt-project.org/gitweb?p=qt/qtvirtualkeyboard.git;a=patch;h=c0ac7a4c684e2fed60a72ceee53da89eea3f95a7";
      ...
      (fetchpatch {
        ...
        url =
          "https://codereview.qt-project.org/gitweb?p=qt/qtvirtualkeyboard.git;a=patch;h=a2e7b8412f56841e12ed20a39f4a38e32d3c1e30";
