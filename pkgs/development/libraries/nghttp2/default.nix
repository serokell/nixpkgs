...
in stdenv.mkDerivation rec {
  ...
  buildInputs = [ openssl libev zlib c-ares ] ++ optional enableHpack jansson
    ++ optional enableAsioLib boost ++ optional enableGetAssets libxml2
  ...
  ] ++ optional enableAsioLib
    "--enable-asio-lib --with-boost-libdir=${boost}/lib";
