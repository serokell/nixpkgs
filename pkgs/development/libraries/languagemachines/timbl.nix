{ stdenv, fetchurl, automake, autoconf, libtool, pkgconfig, autoconf-archive, libxml2, bzip2, libtar, languageMachines
}:

let
  release = builtins.fromJSON
    (builtins.readFile ./release-info/LanguageMachines-timbl.json);
