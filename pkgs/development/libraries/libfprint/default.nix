...
stdenv.mkDerivation rec {
  ...
  src = {
    ...
    libfprint = fetchurl {
      url =
        "https://gitlab.freedesktop.org/libfprint/libfprint/uploads/82ba3cef5bdf72997df711eacdb13c0f/libfprint-${version}.tar.xz";
  ...
  nativeBuildInputs =
    [ pkgconfig meson ninja gtk-doc docbook_xsl docbook_xml_dtd_43 ];
