{ stdenv, lib, fetchurl, gfortran, pkgconfig, blas, zlib, bzip2, withGurobi ?
  false, gurobi, withCplex ? false, cplex }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ blas zlib bzip2 ] ++ lib.optional withGurobi gurobi
  ...
  NIX_LDFLAGS = lib.optional withCplex "-L${cplex}/cplex/bin/${cplex.libArch}";
