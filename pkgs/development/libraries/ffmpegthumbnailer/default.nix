...
stdenv.mkDerivation rec {
  ...
  meta = with stdenv.lib; {
    ...
    longDescription = ''
      ...
      videoformats depend on the configuration flags of ffmpeg. This thumbnailer
      was designed to be as fast and lightweight as possible. The only
      dependencies are ffmpeg and libpng.
    '';
