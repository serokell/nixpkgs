...
stdenv.mkDerivation (rec {
  ...
  configureFlags =
    [ "--disable-debug" "--with-python=${python}" "CPPFLAGS=-D_GNU_SOURCE" ];
  ...
  patches = [ ./deadlock.patch ] ++ map fetchurl (import ./debian-patches.nix)
    ...
    ++ stdenv.lib.optional stdenv.hostPlatform.isMusl (fetchpatch {
      ...
      url =
        "https://git.alpinelinux.org/cgit/aports/plain/main/gamin/fix-pthread-mutex.patch?h=3.4-stable&id=a1a836b089573752c1b0da7d144c0948b04e8ea8";
