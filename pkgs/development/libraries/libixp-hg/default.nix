...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://storage.googleapis.com/google-code-archive-source/v2/code.google.com/libixp/source-archive.zip";
  ...
  meta = {
    homepage =
      "http://repo.cat-v.org/libixp/"; # see also https://libs.suckless.org/deprecated/libixp
