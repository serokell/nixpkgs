...
let inherit (python2Packages) python pygobject2 pygtk;
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "${meta.homepage}/${versionMajor}/${version}/+download/libappindicator-${version}.tar.gz";
  ...
  buildInputs =
    [ glib dbus-glib python pygobject2 pygtk gobject-introspection vala ]
