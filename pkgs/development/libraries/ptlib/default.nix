...
stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      url =
        "http://sources.debian.net/data/main/p/ptlib/2.10.11~dfsg-2.1/debian/patches/bison-fix";
      sha256 = "0vzv9kyn9s628z8wy2gva380gi1rmhxilwlg5pikl5a0wn8p46nw";
    })
    (fetchpatch {
      url =
        "http://sources.debian.net/data/main/p/ptlib/2.10.11~dfsg-2.1/debian/patches/no-sslv3";
  ...
  passthru = {
    updateInfo = { downloadPage = "http://ftp.gnome.org/sources/ptlib/"; };
