{ stdenv, fetchurl, cmake, qtbase, pkgconfig, python2Packages, dbus-glib, dbus, telepathy-farstream, telepathy-glib, fetchpatch
}:
...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://telepathy.freedesktop.org/releases/telepathy-qt/${name}.tar.gz";
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/TelepathyIM/telepathy-qt/commit/d654dc70dbec7097e96e6d96ca74ab1b5b00ef8c.patch";
