...
, at-spi2-core, atk, dbus, glib, libxml2, fixDarwinDylibNames
...
stdenv.mkDerivation rec {
  ...
  meta = with stdenv.lib; {
    ...
    license =
      licenses.lgpl2Plus; # NOTE: 2018-06-06: Please check the license when upstream sorts-out licensing: https://gitlab.gnome.org/GNOME/at-spi2-atk/issues/2
