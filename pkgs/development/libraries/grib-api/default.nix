...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ cmake netcdf gfortran jasper libpng ]
    ++ stdenv.lib.optionals enablePython [ pythonPackages.python ];

  propagatedBuildInputs =
    stdenv.lib.optionals enablePython [ pythonPackages.numpy ];
