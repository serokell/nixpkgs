...
{ stdenv, fetchurl, lib, file, pkgconfig, autoconf, glib, dbus-glib, libdbusmenu
, gtkVersion ? "3", gtk2 ? null, gtk3 ? null, pythonPackages
, gobject-introspection, vala, gnome-doc-utils, monoSupport ? false, mono ? null
, gtk-sharp-2_0 ? null }:
