{ stdenv, fetchurl, unzip, cmake, libGLU_combined, freeglut, libX11, xorgproto, libXi, pkgconfig
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ unzip cmake libGLU_combined freeglut libX11 xorgproto libXi ];
