...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      name = "siginfo.patch";
      url =
        "https://git.archlinux.org/svntogit/packages.git/plain/trunk/siginfo.patch?h=packages/libstdc%2B%2B5&id=e36ee8ed9bb5942db14cf6249a2ead14974a2bfa";
    ...
    (fetchpatch {
      ...
      url =
        "https://git.archlinux.org/svntogit/packages.git/plain/trunk/gcc-3.4.3-no_multilib_amd64.patch?h=packages/libstdc%2B%2B5&id=e36ee8ed9bb5942db14cf6249a2ead14974a2bfa";
  ...
  meta = with stdenv.lib; {
    ...
    description =
      "GNU Compiler Collection, version ${version} -- C++ standard library";
