...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/zeit/now-cli/releases/download/${version}/now-linux.gz";
  ...
  preFixup = let libPath = lib.makeLibraryPath [ stdenv.cc.cc ];
    in ''
  ...
  meta = with stdenv.lib; {
    ...
    description =
      "The Command Line Interface for Now - Global Serverless Deployments";
