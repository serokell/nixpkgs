...
let
  quicklisp-to-nix-packages = rec {
    ...
    "rt" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."rt" or (x: { }))
      ...
      ((f: x: (x // (f x))) (qlOverrides."iolib_dot_grovel" or (x: { }))
        (import ./quicklisp-to-nix-output/iolib_dot_grovel.nix {
          ...
          "iolib_dot_common-lisp" =
            quicklisp-to-nix-packages."iolib_dot_common-lisp";
      ...
      ((f: x: (x // (f x))) (qlOverrides."hu_dot_dwim_dot_stefil" or (x: { }))
        (import ./quicklisp-to-nix-output/hu_dot_dwim_dot_stefil.nix {
          ...
          "hu_dot_dwim_dot_asdf" =
            quicklisp-to-nix-packages."hu_dot_dwim_dot_asdf";
        }));
    ...
    "kmrcl" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."kmrcl" or (x: { }))
        (import ./quicklisp-to-nix-output/kmrcl.nix { inherit fetchurl; }));
    ...
    "myway" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."myway" or (x: { }))
    ...
    "map-set" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."map-set" or (x: { }))
        (import ./quicklisp-to-nix-output/map-set.nix { inherit fetchurl; }));
    ...
    "lack-middleware-backtrace" = buildLispPackage ((f: x: (x // (f x)))
    ...
    "clack-test" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."clack-test" or (x: { }))
        (import ./quicklisp-to-nix-output/clack-test.nix {
          ...
          "clack-handler-hunchentoot" =
            quicklisp-to-nix-packages."clack-handler-hunchentoot";
    ...
    "clack-handler-hunchentoot" = buildLispPackage ((f: x: (x // (f x)))
    ...
    "cl-project" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."cl-project" or (x: { }))
    ...
    "salza2" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."salza2" or (x: { }))
        (import ./quicklisp-to-nix-output/salza2.nix { inherit fetchurl; }));
      ...
      ((f: x: (x // (f x))) (qlOverrides."query-fs" or (x: { }))
        (import ./quicklisp-to-nix-output/query-fs.nix {
          ...
          "command-line-arguments" =
            quicklisp-to-nix-packages."command-line-arguments";
          "iterate" = quicklisp-to-nix-packages."iterate";
    ...
    "plump" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."plump" or (x: { }))
        (import ./quicklisp-to-nix-output/plump.nix {
          ...
          "documentation-utils" =
            quicklisp-to-nix-packages."documentation-utils";
    ...
    "css-selectors-simple-tree" = buildLispPackage ((f: x: (x // (f x)))
    ...
    "clx-truetype" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."clx-truetype" or (x: { }))
    ...
    "clack-v1-compat" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."clack-v1-compat" or (x: { }))
    ...
    "caveman" = buildLispPackage
      ((f: x: (x // (f x))) (qlOverrides."caveman" or (x: { }))
