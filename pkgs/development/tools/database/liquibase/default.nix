{ stdenv, fetchurl, jre, makeWrapper, mysqlSupport ? true, mysql_jdbc ? null }:
...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/liquibase/liquibase/releases/download/${pname}-parent-${version}/${name}-bin.tar.gz";
