...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/ninja-build/ninja/commit/9aa947471fcfc607bec6d92a1a6eed5c692edbaf.patch";
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/makepost/ninja/commit/567815df38a2ff54ad7478a90bd75c91e434236a.patch";
      sha256 = "0zd0xyi7h2066nw1dsk76c7yf71b0f7v4p5nljda7jxi01vpdh69";
    })
  ];

  nativeBuildInputs = [ python re2c ] ++ optionals buildDocs [
    asciidoc
    docbook_xml_dtd_45
    docbook_xsl
    libxslt.bin
