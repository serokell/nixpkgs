...
let
  param = if stdenv.lib.versionAtLeast ocaml.version "4" then {
    version = "1.8.0";
    ...
    patches = [
      (fetchpatch {
        url =
          "https://raw.githubusercontent.com/ocaml/opam-repository/1f29c5ef8eccd373e5ff2169a30bfd95a9ae6050/packages/ocamlfind/ocamlfind.1.7.3-1/files/threads.patch";
...
in stdenv.mkDerivation rec {
  ...
  meta = {
    ...
    maintainers =
      [ stdenv.lib.maintainers.z77z stdenv.lib.maintainers.vbmithr ];
  };
}
