{ stdenv, fetchzip, boost, cmake, ncurses, python2, z3Support ? true, z3 ? null
}:
...
in stdenv.mkDerivation rec {
  ...
  patches = stdenv.lib.optionals buildSharedLibs
  ...
  cmakeFlags = [ "-DBoost_USE_STATIC_LIBS=OFF" ]
    ++ stdenv.lib.optionals buildSharedLibs [ "-DBUILD_SHARED_LIBS=ON" ]
    ++ stdenv.lib.optionals (!z3Support) [ "-DUSE_Z3=OFF" ];
