...
stdenv.mkDerivation {
  ...
  src = if stdenv.hostPlatform.system == "i686-linux" then
    fetchurl {
      url =
        "mirror://sourceforge/project/freepascal/Linux/2.6.0/fpc-2.6.0.i386-linux.tar";
      sha256 = "08yklvrfxvk59bxsd4rh1i6s3cjn0q06dzjs94h9fbq3n1qd5zdf";
    }
  else if stdenv.hostPlatform.system == "x86_64-linux" then
    fetchurl {
      url =
        "mirror://sourceforge/project/freepascal/Linux/2.6.0/fpc-2.6.0.x86_64-linux.tar";
