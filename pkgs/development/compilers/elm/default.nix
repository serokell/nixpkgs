...
let
  ...
  patchBinwrap =
    import ./packages/patch-binwrap.nix { inherit lib writeScriptBin stdenv; };

  elmNodePackages = import ./packages/node-composition.nix {
    inherit nodejs pkgs;
        ...
        elmPkgs = rec {
          elm = overrideCabal (self.callPackage ./packages/elm.nix { }) (drv: {
            ...
            patches = [
              (fetchpatch {
                url =
                  "https://github.com/elm/compiler/pull/1886/commits/39d86a735e28da514be185d4c3256142c37c2a8a.patch";
          ...
          */
          elm-format = justStaticExecutables
            (doJailbreak (self.callPackage ./packages/elm-format.nix { }));
          ...
          */
          ...
          elm-verify-examples =
            patchBinwrap [ elmi-to-json ] elmNodePackages.elm-verify-examples;
