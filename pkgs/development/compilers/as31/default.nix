...
in stdenv.mkDerivation {
  ...
  src = fetchurl {
    ...
    url =
      "http://wiki.erazor-zone.de/_media/wiki:projects:linux:as31:as31-${version}.tar.gz";
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://bugs.debian.org/cgi-bin/bugreport.cgi?att=1;bug=655496;filename=as31-mkstemps.patch;msg=5";
