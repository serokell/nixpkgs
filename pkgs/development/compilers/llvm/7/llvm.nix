{ stdenv, fetch, fetchpatch, cmake, python, libffi, libbfd, libpfm, libxml2
, ncurses, version, release_version, zlib, buildPackages, debugVersion ? false
...
let
  ...
  polly_src =
    fetch "polly" "16qkns4ab4x0azrvhy4j7cncbyb2rrbdrqj87zphvqxm5pvm8m1h";

  # Used when creating a versioned symlinks of libLLVM.dylib
  versionSuffixes = with stdenv.lib;
    let parts = splitString "." release_version;
