...
stdenv.mkDerivation {
  ...
  src =
    fetch "libunwind" "0q7ndlldid9wchnny0a936llwxj7zgb9gxp46wjjxvwwkik3l97z";
  ...
  patches = [
    (fetchpatch {
      url =
        "https://github.com/llvm-mirror/libunwind/commit/34a45c630d4c79af403661d267db42fbe7de1178.patch";
