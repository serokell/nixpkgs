...
in stdenv.mkDerivation {
  ...
  buildInputs = [ groff libxml2 libffi ];
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/llvm-mirror/llvm/commit/5340b5b3d970069aebf3dde49d8964583742e01a.patch";
  ...
  postPatch = "" + ''
    patch -p1 --reverse < ${
      fetchpatch {
        name =
          "fix-red-icons.diff"; # https://bugs.freedesktop.org/show_bug.cgi?id=99078
  ...
  cmakeFlags = with stdenv;
    ...
    ++ stdenv.lib.optional enableSharedLibraries [ "-DLLVM_LINK_LLVM_DYLIB=ON" ]
