...
let
  jdk = stdenv.mkDerivation {
    ...
    src = fetchurl {
      url =
        "https://bitbucket.org/alexkasko/openjdk-unofficial-builds/downloads/openjdk-1.7.0-u60-unofficial-macosx-x86_64-bundle.zip";
      sha256 =
        "af510a4d566712d82c17054bb39f91d98c69a85586e244c6123669a0bd4b7401";
    };
