...
let
  ...
  gradle_ = (gradleGen.override { jdk = bootjdk; }).gradle_4_10;
  ...
  makePackage = args:
    stdenv.mkDerivation ({
      ...
      src = fetchurl {
        url =
          "http://hg.openjdk.java.net/openjfx/${major}/rt/archive/${repover}.tar.gz";
  ...
  deps = makePackage {
    ...
    outputHash =
      ...
      if stdenv.system == "x86_64-linux" then
        "0d4msxswdav1xsfkpr0qd3xgqkcbxzf47v1zdy5jmg5w4bs6a78a"
      else if stdenv.system == "i686-linux" then
        "0mjlyf6jvbis7nrm5d394sjv4hjw6k3753hr1nwdxk8skwc3ry08"
      else
