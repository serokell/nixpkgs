{ stdenv, fetchurl, makeWrapper, boost, gmp, tcl-8_5, tk-8_5, emacs }:
...
in stdenv.mkDerivation {
  ...
  libPath =
    stdenv.lib.makeLibraryPath [ stdenv.cc.cc boost gmp tcl-8_5 tk-8_5 ];
  ...
  buildCommand = ''
    ...
    ${stdenv.lib.optionalString (emacs != null) ''
      wrapProgram $out/bin/oz --suffix PATH ":" ${
        stdenv.lib.makeBinPath [ emacs ]
      }
    ''}
