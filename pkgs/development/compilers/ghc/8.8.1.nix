...
# build-tools
, bootPkgs, autoconf, automake, coreutils, fetchurl, perl, python3, m4, sphinx, bash
...
let
  ...
  libDeps = platform:
    stdenv.lib.optional enableTerminfo [ ncurses ] ++ [ libffi ]
...
in stdenv.mkDerivation (rec {
  ...
  src = fetchurl {
    url =
      "https://downloads.haskell.org/~ghc/8.8.1-alpha2/ghc-${version}-src.tar.xz";
