    ...
    [
      ...
      [
        (if crossDarwin then
          ...
          "--with-headers=${getDev libcCross}/include")
        "--enable-__cxa_atexit"
        "--enable-long-long"
      ] ++ (if crossMingw then [
        "--enable-threads=win32"
...
in stdenv.mkDerivation ({
  ...
  configureFlags =
    ...
    optional (targetPlatform == hostPlatform && targetPlatform.isi686)
    "--with-arch=i686" ++ optionals hostPlatform.isSunOS [
      "--enable-long-long"
      "--enable-libssp"
