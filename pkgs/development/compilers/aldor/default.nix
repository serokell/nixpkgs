{ fetchgit, stdenv, gmp, which, flex, bison, makeWrapper, autoconf, automake, libtool, jdk, perl
}:
...
stdenv.mkDerivation {
  ...
  buildInputs =
    [ gmp which flex bison makeWrapper autoconf automake libtool jdk perl ];
