  ...
  junit_3_8_1 = map (obj:
    fetchMaven {
    ...
    }) [
      {
        type = "pom";
        sha512 =
          "2b368057s8i61il387fqvznn70r9ndm815r681fn9i5afs1qgkw7i1d6vsn3pv2bbif1kmhb7qzcc574m3xcwc8a2mqw44b4bbxsfyl";
      }
      {
        type = "jar";
        sha512 =
  ...
  junit_3_8_2 = map (obj:
    fetchMaven {
    ...
    }) [
      {
        type = "pom";
        sha512 =
          "01npyfwl1f44l44x92cvqqcp58sckcjraf78dav6zgag3x6ispd9gz594nhpqckmjw0hlrkbqfxnzdcq1mlsj9rw6zyq4wk5ch8rl5j";
      }
      {
        type = "jar";
        sha512 =
