{ stdenv, fetchurl, python, cairomm, sparsehash, pycairo, autoreconfHook, pkgconfig, boost, expat, scipy, cgal, gmp, mpfr, gobject-introspection, pygobject3, gtk3, matplotlib, ncurses, buildPythonPackage, fetchpatch, pythonAtLeast, lib
}:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://git.skewed.de/count0/graph-tool/commit/aa39e4a6b42d43fac30c841d176c75aff92cc01a.patch";
    ...
    (fetchpatch {
      ...
      url =
        "https://git.skewed.de/count0/graph-tool/commit/0407f41a35b6be7c670927fb5dc578cbd0e88be4.patch";
