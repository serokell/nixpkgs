{ lib, buildPythonPackage, fetchPypi, msrest, msrestazure, azure-common, isPy3k, azure-mgmt-nspkg
}:
...
buildPythonPackage rec {
  ...
  meta = with lib; {
    ...
    homepage =
      "https://github.com/Azure/azure-sdk-for-python/tree/master/azure-mgmt-advisor";
