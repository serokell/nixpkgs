{ stdenv, lib, fetchPypi, buildPythonPackage, isPy3k, numpy, werkzeug, protobuf, grpcio, markdown, futures, absl-py
}:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ numpy werkzeug protobuf markdown grpcio absl-py ]
