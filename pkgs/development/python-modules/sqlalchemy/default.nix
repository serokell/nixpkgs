{ lib, fetchPypi, fetchpatch, buildPythonPackage, pytest, mock, isPy3k, pysqlite
}:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://bitbucket.org/zzzeek/sqlalchemy/commits/63279a69e2b9277df5e97ace161fa3a1bb4f29cd/raw";
