{ lib, buildPythonPackage, fetchPypi, eradicate, mccabe, pycodestyle, pydocstyle, pyflakes, pytest, ipdb
}:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ eradicate mccabe pycodestyle pydocstyle pyflakes ];
