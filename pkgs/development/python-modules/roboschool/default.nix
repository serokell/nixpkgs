...
buildPythonPackage rec {
  ...
  buildInputs = [ bullet-roboschool assimp qt5.qtbase boost ];
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/openai/roboschool/pull/180/commits/334f489c8ce7af4887e376139ec676f89da5b16f.patch";
