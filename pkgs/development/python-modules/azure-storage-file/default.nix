{ lib, buildPythonPackage, fetchPypi, azure-common, azure-storage-common, isPy3k, futures
}:
...
buildPythonPackage rec {
  ...
  meta = with lib; {
    ...
    homepage =
      "https://github.com/Azure/azure-storage-python/tree/master/azure-storage-file";
