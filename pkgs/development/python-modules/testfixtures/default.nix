{ stdenv, buildPythonPackage, fetchPypi, fetchpatch, mock, pytest, sybil, zope_component
}:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/Simplistix/testfixtures/commit/6e8807543b804946aba58e2c9e92f5bdc3656a57.patch";
