{ stdenv, buildPythonPackage, fetchPypi, pytest, fetchpatch, glibcLocales }:
...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch {
      url =
        "https://github.com/drkjam/netaddr/commit/2ab73f10be7069c9412e853d2d0caf29bd624012.patch";
