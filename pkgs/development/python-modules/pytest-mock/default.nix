{ lib, buildPythonPackage, fetchPypi, fetchpatch, isPy3k, pytest, mock
, setuptools_scm }:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/pytest-dev/pytest-mock/commit/189cc599d3bfbe91a17c93211c04237b6c5849b1.patch";
