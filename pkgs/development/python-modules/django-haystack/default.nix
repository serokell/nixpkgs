{ lib, buildPythonPackage, fetchPypi, setuptools_scm, django, dateutil, whoosh, pysolr, coverage, mock, nose, geopy, requests
}:
...
buildPythonPackage rec {
  ...
  checkInputs =
    [ pysolr whoosh dateutil geopy coverage nose mock coverage requests ];
