{ stdenv, fetchPypi, python, buildPythonPackage, isPy3k, pycairo
...
, pygobject3, enableGhostscript ? true, ghostscript ? null, gtk3
, enableGtk2 ? false, pygtk ? null, gobject-introspection, enableGtk3 ? false
, cairo
