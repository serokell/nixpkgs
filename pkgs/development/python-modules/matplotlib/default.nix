{ stdenv, fetchPypi, python, buildPythonPackage, isPy3k, pycairo, backports_functools_lru_cache, which, cycler, dateutil, nose, numpy, pyparsing, sphinx, tornado, kiwisolver, freetype, libpng, pkgconfig, mock, pytz, pygobject3, enableGhostscript ?
  true, ghostscript ? null, gtk3, enableGtk2 ? false, pygtk ?
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [
    ...
    ++ stdenv.lib.optional enableGtk2 pygtk ++ stdenv.lib.optionals enableGtk3 [
      cairo
      pycairo
      gtk3
