{ buildPythonPackage, fetchPypi, fetchpatch, lib, pexpect, pytest }:
...
buildPythonPackage rec {
  ...
  patches = fetchpatch {
    url =
      "https://bitbucket.org/pytest-dev/pytest-timeout/commits/36998c891573d8ec1db1acd4f9438cb3cf2aee2e/raw";
