...
if withTeensyduino && (stdenv.hostPlatform.system != "x86_64-linux") then
  throw
  ...
  let
    ...
    patchelfInJars =
      lib.optional (stdenv.hostPlatform.system == "x86_64-linux") {
        jar = "share/arduino/lib/jssc-2.8.0-arduino1.jar";
    ...
    teensy_architecture =
      ...
      "linux32" + lib.optionalString (stdenv.hostPlatform.system == "arm-linux")
      "linuxarm";
  ...
  in stdenv.mkDerivation rec {
    ...
    teensyduino_src = fetchurl {
      ...
      sha256 = lib.optionalString ("${teensy_architecture}" == "linux64")
    ...
    arduino_dist_src = fetchurl {
      url =
        "http://downloads.arduino.cc/arduino-${version}-${teensy_architecture}.tar.xz";
      sha256 = lib.optionalString ("${teensy_architecture}" == "linux64")
