...
let
  packages = (self:
    ...
    let
      ...
      lua-setup-hook =
        callPackage ../development/interpreters/lua-5/setup-hook.nix { };
      ...
      buildLuarocksPackage = with pkgs.lib;
        makeOverridable
    ...
    in with self; {
      ...
      getLuaPathList = majorVersion: [
        "lib/lua/${majorVersion}/?.lua"
        "share/lua/${majorVersion}/?.lua"
        "share/lua/${majorVersion}/?/init.lua"
        "lib/lua/${majorVersion}/?/init.lua"
      ];
      getLuaCPathList = majorVersion: [
        "lib/lua/${majorVersion}/?.so"
        "share/lua/${majorVersion}/?.so"
        "share/lua/${majorVersion}/?/init.so"
      ];

      # helper functions for dealing with LUA_PATH and LUA_CPATH
      getPath = lib: type:
        "${lib}/lib/lua/${lua.luaversion}/?.${type};${lib}/share/lua/${lua.luaversion}/?.${type}";
      ...
      inherit requiredLuaModules luaOlder luaAtLeast isLua51 isLua52 isLua53
        isLuaJIT lua callPackage;
      ...
      luarocks =
        callPackage ../development/tools/misc/luarocks { inherit lua; };
