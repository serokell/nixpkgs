...
let
  mkCoqPackages' = self: coq:
    ...
    in {
      ...
      contribs =
        recurseIntoAttrs (callPackage ../development/coq-modules/contribs { });
      ...
      inherit (callPackage ../development/coq-modules/mathcomp { })
        ...
        mathcompCorePkgs mathcomp mathcomp-ssreflect mathcomp-fingroup
        mathcomp-algebra mathcomp-solvable mathcomp-field mathcomp-character

        mathcompCorePkgs_1_7 mathcomp_1_7 mathcomp-ssreflect_1_7
        mathcomp-fingroup_1_7 mathcomp-algebra_1_7 mathcomp-solvable_1_7
        mathcomp-field_1_7 mathcomp-character_1_7

        mathcompCorePkgs_1_8 mathcomp_1_8 mathcomp-ssreflect_1_8
        mathcomp-fingroup_1_8 mathcomp-algebra_1_8 mathcomp-solvable_1_8
        mathcomp-field_1_8 mathcomp-character_1_8

        mathcompCorePkgs_1_9 mathcomp_1_9 mathcomp-ssreflect_1_9
        mathcomp-fingroup_1_9 mathcomp-algebra_1_9 mathcomp-solvable_1_9
        mathcomp-field_1_9 mathcomp-character_1_9;
  ...
  filterCoqPackages = coq: set:
    ...
    let v = set.${name};
    in let p = v.compatibleCoqVersions or (_: true);
    in lib.optional (p coq.coq-version) (lib.nameValuePair name
    (if lib.isAttrs v && v.recurseForDerivations or false then
      filterCoqPackages coq v
    else
      v))) (lib.attrNames set));
...
in rec {
  ...
  mkCoqPackages = coq:
    ...
    in if coq.dontFilter or false then self else filterCoqPackages coq self;
  ...
  coq_8_7 =
    callPackage ../applications/science/logic/coq { version = "8.7.2"; };
  coq_8_8 =
    callPackage ../applications/science/logic/coq { version = "8.8.2"; };
  coq_8_9 =
    callPackage ../applications/science/logic/coq { version = "8.9.1"; };
  coq_8_10 =
    callPackage ../applications/science/logic/coq { version = "8.10+beta2"; };
  ...
  coqPackages = recurseIntoAttrs
    (lib.mapDerivationAttrset lib.dontDistribute coqPackages_8_8);
  coq = coqPackages.coq;
