...
, emacs, texinfo, lndir, makeWrapper, trivialBuild, melpaBuild
...
let
  ...
  melpaStablePackages =
    import ../applications/editors/emacs-modes/melpa-stable-packages.nix {
      inherit external;
    };
  ...
  packagesFun = self:
    with self; {
      ...
      emacsql-sqlite = melpaBuild rec {
        ...
        recipe = fetchurl {
          url =
            "https://raw.githubusercontent.com/milkypostman/melpa/3cfa28c7314fa57fa9a3aaaadf9ef83f8ae541a9/recipes/emacsql-sqlite";
      ...
      emacs-libvterm =
        callPackage ../applications/editors/emacs-modes/emacs-libvterm { };
      ...
      evil-jumper = melpaBuild rec {
        ...
        meta = {
          description =
            "Jump across buffer boundaries and revive dead buffers if necessary";
          license = gpl3Plus;
        };
      };
      ...
      filesets-plus =
        callPackage ../applications/editors/emacs-modes/filesets-plus { };

      font-lock-plus =
        callPackage ../applications/editors/emacs-modes/font-lock-plus { };
      ...
      irony = melpaBuild rec {
        ...
        recipe = fetchurl {
          url =
            "https://raw.githubusercontent.com/milkypostman/melpa/3cfa28c7314fa57fa9a3aaaadf9ef83f8ae541a9/recipes/irony";
        ...
        nativeBuildInputs = [
          external.cmake
          external.llvmPackages.llvm
          external.llvmPackages.clang
        ];
        meta = {
      ...
      thingatpt-plus =
        callPackage ../applications/editors/emacs-modes/thingatpt-plus { };
      ...
      zmq = melpaBuild rec {
        ...
        recipe = fetchurl {
          url =
            "https://raw.githubusercontent.com/milkypostman/melpa/72f4dcc2723de826bf1af7235ac6d9119a243c63/recipes/zmq";
...
{ } // elpaPackages self // melpaStablePackages self // melpaPackages self
// orgPackages self // packagesFun self)
