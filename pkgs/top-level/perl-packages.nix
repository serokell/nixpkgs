  ...
  _self = with self;
  {
    ...
    */
    ...
    DBIxClassSchemaLoader = buildPerlPackage {
      ...
      propagatedBuildInputs =
        [ CarpClan ClassUnload DBIxClass DataDump StringToIdentifierEN curry ];
      meta = {
    ...
    DBIxSimple = buildPerlPackage {
      ...
      propagatedBuildInputs = [ DBI ];
      meta = { description = "Very complete easy-to-use OO interface to DBI"; };
    };
    ...
    DistZilla = buildPerlPackage {
      ...
      buildInputs =
        [ CPANMetaCheck TestDeep TestFailWarnings TestFatal TestFileShareDir ];
      propagatedBuildInputs = [
        AppCmd
        CPANUploader
        ConfigMVPReaderINI
    ...
    Gnome2 = buildPerlPackage {
      ...
      buildInputs =
        [ ExtUtilsDepends ExtUtilsPkgConfig Glib Gnome2Canvas Gnome2VFS Gtk2 ];
    ...
    NetAmazonEC2 = buildPerlPackage {
      ...
      buildInputs = [ pkgs.unzip ];
      patches = [ # In DescribeInstance requests, say "InstanceId.1" instead of
    ...
    SOAPLite = buildPerlPackage {
      ...
      propagatedBuildInputs =
        [ ClassInspector IOSessionData LWPProtocolHttps TaskWeaken XMLParser ];
      meta = {
    ...
    TestClassMost = buildPerlModule {
      ...
      buildInputs =
        [ TestClass TestDeep TestDifferences TestException TestMost TestWarn ];
      meta = {
    ...
    TestHTTPServerSimple = buildPerlPackage {
      ...
      propagatedBuildInputs = [ HTTPServerSimple ];
      meta = { description = "Test::More functions for HTTP::Server::Simple"; };
    };
