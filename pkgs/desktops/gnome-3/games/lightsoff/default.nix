{ stdenv, fetchurl, vala, pkgconfig, gtk3, gnome3, gdk_pixbuf, librsvg, wrapGAppsHook, gettext, itstool, clutter, clutter-gtk, libxml2, appstream-glib, meson, ninja, python3
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ gtk3 gnome3.adwaita-icon-theme gdk_pixbuf librsvg clutter clutter-gtk ];
