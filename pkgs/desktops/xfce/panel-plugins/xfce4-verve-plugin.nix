{ stdenv, fetchurl, pkgconfig, intltool, glib, exo, pcre, libxfce4util, xfce4-panel, libxfce4ui, xfconf, gtk
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ intltool glib exo pcre libxfce4util libxfce4ui xfce4-panel xfconf gtk ];
