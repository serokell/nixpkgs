...
, libxfcegui4, xfconf, gtk, hicolor-icon-theme }:
...
stdenv.mkDerivation rec {
  ...
  meta = {
    ...
    description =
      "A simple XFCE panel plugin that lets the user run an alarm at a specified time or at the end of a specified countdown period";
