{ stdenv, pkgconfig, fetchFromGitHub, python2, vala_0_40, gtk2, libwnck, libxfce4util, xfce4-panel, wafHook
}:
...
stdenv.mkDerivation rec {
  ...
  meta = with stdenv.lib; {
    ...
    description =
      "A plugins which integrates titlebar and window controls into the xfce4-panel";
