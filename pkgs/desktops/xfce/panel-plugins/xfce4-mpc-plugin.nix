{ stdenv, fetchurl, pkgconfig, intltool, libxfce4util, xfce4-panel, libxfce4ui, libxfcegui4, xfconf, gtk, exo
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ intltool libxfce4util libxfce4ui xfce4-panel libxfcegui4 xfconf gtk exo ];
