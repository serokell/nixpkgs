...
lib.makeScope pkgs.newScope (self:
  with self;
  {
    ...
    xfce4-screenshooter =
      callPackage ./applications/xfce4-screenshooter.nix { };

    xfce4-volumed = callPackage ./applications/xfce4-volumed.nix { };

    xfce4-volumed-pulse =
      callPackage ./applications/xfce4-volumed-pulse.nix { };
    ...
    xfce4-genmon-plugin =
      callPackage ./panel-plugins/xfce4-genmon-plugin.nix { };
    ...
    xfce4_power_manager_gtk3 =
      xfce4-power-manager.override { withGtk3 = true; };
