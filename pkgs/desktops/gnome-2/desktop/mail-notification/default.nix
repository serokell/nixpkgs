...
, libgnome-keyring, openssl, cyrus_sasl, gnonlin, sylpheed, gob2, gettext
, intltool, libxml2, hicolor-icon-theme, tango-icon-theme }:
...
stdenv.mkDerivation rec {
  ...
  patches = [ ./patches/mail-notification-dont-link-against-bsd-compat.patch ];
