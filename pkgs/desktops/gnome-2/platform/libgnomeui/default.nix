{ stdenv, fetchurl, fetchpatch, pkgconfig, libxml2, xorg, glib, pango, intltool, libgnome, libgnomecanvas, libbonoboui, GConf, libtool, gnome_vfs, libgnome-keyring, libglade
}:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://github.com/GNOME/libgnomeui/commit/30334c28794ef85d8973f4ed0779b5ceed6594f2.diff";
