{ stdenv, fetchurl, pkgconfig, gtk3, intltool, GConf, enchant, isocodes, gnome_icon_theme, gsettings-desktop-schemas
}:
...
stdenv.mkDerivation rec {
  ...
  propagatedBuildInputs =
    [ gsettings-desktop-schemas gtk3 gnome_icon_theme GConf ];
