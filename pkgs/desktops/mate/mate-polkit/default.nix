{ stdenv, fetchurl, pkgconfig, intltool, gtk3, gobject-introspection
, libappindicator-gtk3, libindicator-gtk3, polkit }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ gobject-introspection intltool pkgconfig ];
