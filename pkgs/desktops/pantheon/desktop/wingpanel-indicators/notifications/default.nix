{ stdenv, fetchFromGitHub, pantheon, pkgconfig, meson, ninja, vala, gtk3, granite, wingpanel, libgee, libwnck3, elementary-icon-theme, wrapGAppsHook
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ elementary-icon-theme granite gtk3 libgee libwnck3 wingpanel ];
