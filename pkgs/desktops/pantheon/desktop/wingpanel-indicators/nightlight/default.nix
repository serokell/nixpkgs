{ stdenv, fetchFromGitHub, pantheon, pkgconfig, meson, ninja, vala, gtk3, granite, wingpanel, libgee, libxml2, elementary-icon-theme, wrapGAppsHook
}:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ libxml2 meson ninja pkgconfig vala wrapGAppsHook ];
