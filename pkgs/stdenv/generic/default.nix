  ...
  stdenv = derivation (lib.optionalAttrs (allowedRequisites != null) {
    ...
    // rec {
      ...
      inherit (hostPlatform)
        isDarwin isLinux isSunOS isCygwin isFreeBSD isOpenBSD isi686 isx86_32
        isx86_64 is32bit is64bit isAarch32 isAarch64 isMips isBigEndian;
      isArm = lib.warn
      ...
      inherit (import ./make-derivation.nix { inherit lib config stdenv; })
        mkDerivation;
