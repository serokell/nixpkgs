...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0001-fail-logging.patch?h=rssh";
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0002-info-to-debug.patch?h=rssh";
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0003-man-page-spelling.patch?h=rssh";
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0004-mkchroot.patch?h=rssh";
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0005-mkchroot-arch.patch?h=rssh";
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0006-mkchroot-symlink.patch?h=rssh";
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0007-destdir.patch?h=rssh";
    ...
    (fetchurl {
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/0008-rsync-protocol.patch?h=rssh";
