...
let
  ...
  mameSrc = fetchurl {
    url =
      "https://github.com/mamedev/mame/releases/download/mame0139/mame0${version}s.zip";
...
in stdenv.mkDerivation {
  ...
  buildInputs = [ unzip pkgconfig SDL gtk2 GConf libGLU_combined expat zlib ];
  ...
  meta = {
    ...
    description =
      "Multi Emulator Super System, an emulator of many game consoles and computer systems";
    broken = true;
  };
}
