{ stdenv, fetchurl, cmake, pkgconfig, qtbase, qt5, libGLU_combined, freeglut ?
  null, openal ? null, SDL2 ? null }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://download.tuxfamily.org/yabause/releases/${version}/${name}.tar.gz";
    sha256 = "1cn2rjjb7d9pkr4g5bqz55vd4pzyb7hg94cfmixjkzzkw0zw8d23";
  };

  nativeBuildInputs = [ cmake pkgconfig ];
  buildInputs =
    [ qtbase qt5.qtmultimedia libGLU_combined freeglut openal SDL2 ];
