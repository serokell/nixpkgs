  ...
  sources = {
    ...
    "hepburn-1.1.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "Ok3ZmMJN3ek4WFAL4f5t8k+BmrDRlS5qGjI4um+3cHH0SrYVzJgUTYwIfGvU8s/eWqOEY+gsINwjJSoaBG3A9g==";
      };
    };
    ...
    "nodejieba-2.3.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "ZzLsVuNDlrmcBQa/b8G/yegdXje2iFmktYmPksk6qLha1brKEANYqg4XPiBspF1D0y7Npho91KTmvKFcDr0UdA==";
      };
    };
    ...
    "pinyin-2.9.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "TZYQ+2uE12arC1EfCeDmN5KgwIOuNMIweOotKvBZdhVOUuQc5RJsGEGf+BaSvxfVtu9ViYEFJmH0xTaj9t4n3Q==";
      };
    };
    "prepend-http-1.0.4" = {
      name = "prepend-http";
