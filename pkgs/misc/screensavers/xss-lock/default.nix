{ stdenv, fetchgit, cmake, docutils, pkgconfig, glib, libpthreadstubs, libXau, libXdmcp, xcbutil
}:
...
stdenv.mkDerivation {
  ...
  buildInputs = [ cmake docutils glib libpthreadstubs libXau libXdmcp xcbutil ];
