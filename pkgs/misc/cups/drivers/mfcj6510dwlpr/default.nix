{ stdenv, fetchurl, pkgsi686Linux, dpkg, makeWrapper, coreutils, gnused, gawk, file, cups, utillinux, xxd, runtimeShell, ghostscript, a2ps
}:
...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    wrapProgram $out/opt/brother/Printers/mfcj6510dw/lpd/filtermfcj6510dw \
      --prefix PATH ":" ${
      stdenv.lib.makeBinPath [ coreutils gnused file ghostscript a2ps ]
      }
  '';
