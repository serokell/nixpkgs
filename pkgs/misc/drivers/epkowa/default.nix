  ...
  plugins = {
    v330 = stdenv.mkDerivation rec {
      ...
      src = fetchurl {
        ...
        sha256 =
          "f6fa455f04cdfbc3d38526573260746e9546830de93ba182d0365f557d2f7df9";
      };
...
in let
  fwdir = symlinkJoin {
    ...
    paths =
      stdenv.lib.mapAttrsToList (name: value: value + /share/esci) plugins;
  };
in let
...
in stdenv.mkDerivation rec {
  ...
  buildInputs = [ gtk2 libxml2 libtool libusb sane-backends makeWrapper ];
  ...
  configureFlags =
    [ "--disable-static" "--enable-dependency-reduction" "--disable-frontend" ];
  ...
  meta = common_meta // {
    ...
    '' + stdenv.lib.concatStringsSep ", "
      (stdenv.lib.mapAttrsToList (name: value: value.passthru.hw) plugins);
