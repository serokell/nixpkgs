...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/Microsoft/ProcDump-for-Linux/commit/1b7b50b910f20b463fb628c8213663c8a8d11d0d.patch";
  ...
  makeFlags = [ "DESTDIR=$(out)" "INSTALLDIR=/bin" "MANDIR=/share/man/man1" ];
