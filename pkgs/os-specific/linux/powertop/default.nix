...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://01.org/sites/default/files/downloads/${pname}-v${version}.tar.gz";
  ...
  patches = stdenv.lib.optional stdenv.hostPlatform.isMusl (fetchpatch {
    ...
    url =
      "https://git.alpinelinux.org/cgit/aports/plain/main/powertop/strerror_r.patch?id=3b9214d436f1611f297b01f72469d66bfe729d6e";
