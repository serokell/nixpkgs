{ stdenv, fetchurl, coreutils, gnugrep, utillinux, kmod, procps, kbd, dbus }:

let

  binPath =
    stdenv.lib.makeBinPath [ coreutils gnugrep utillinux kmod procps kbd dbus ];

  sbinPath = stdenv.lib.makeSearchPathOutput "bin" "sbin" [ procps ];
