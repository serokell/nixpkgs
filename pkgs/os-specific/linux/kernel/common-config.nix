...
let
  ...
  options = {
    ...
    filesystem = {
      ...
      EXT4_ENCRYPTION = {
        optional = true;
        tristate = if (versionOlder version "4.8") then "m" else "y";
      };
    ...
    security = {
      ...
      SECURITY_SELINUX_BOOTPARAM_VALUE =
        freeform "0"; # Disable SELinux by default
    ...
    virtualisation = {
      ...
      KVM_COMPAT = {
        optional = true;
        tristate = whenBetween "4.0" "4.12" "y";
      };
      KVM_DEVICE_ASSIGNMENT = {
        optional = true;
        tristate = whenBetween "3.10" "4.12" "y";
      };
