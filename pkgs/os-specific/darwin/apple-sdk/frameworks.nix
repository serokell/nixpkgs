...
with frameworks; with libs; {
  ...
  DVDPlayback             = {};
  DirectoryService        = {};
  DiscRecording           = { inherit CoreServices IOKit };
  DiscRecordingUI         = {};
  ...
  GSS                     = {};
  GameController          = {};
  GameKit                 = { inherit Foundation };
  Hypervisor              = {};
  ICADevices              = { inherit Carbon IOBluetooth };
  IMServicePlugIn         = {};
  ...
  SecurityFoundation      = {};
  SecurityInterface       = { inherit Security };
  ...
  WebKit                  = { inherit ApplicationServices Carbon JavaScriptCore OpenGL };
