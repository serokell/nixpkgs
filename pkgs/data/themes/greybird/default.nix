{ stdenv, fetchFromGitHub, autoreconfHook, which, sassc, glib, libxml2
, gdk_pixbuf, librsvg, gtk-engine-murrine }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ autoreconfHook which sassc glib libxml2 ];
