...
let
  makePackage = { variant, language, region, sha256 }:
    ...
    in fetchzip {
      ...
      url =
        "https://github.com/adobe-fonts/source-han-serif/raw/${revision}/SubsetOTF/SourceHanSerif${region}.zip";
      ...
      meta = {
        description =
          "${language} subset of an open source Pan-CJK serif typeface";
