...
let
  makePackage = { variant, language, region, sha256 }:
    let
      version = "1.004R";
    ...
    in fetchzip {
      ...
      url =
        "https://github.com/adobe-fonts/source-han-sans/raw/${revision}/SubsetOTF/SourceHanSans${region}.zip";
      ...
      meta = {
        description =
          "${language} subset of an open source Pan-CJK sans-serif typeface";
