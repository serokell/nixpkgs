{ stdenv, fetchurl, rpmextract, makeWrapper, patchelf, qt4, zlib, libX11, libXt
, libSM, libICE, libXext, libGLU_combined }:
...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    ...
    url =
      "https://drive.google.com/uc?export=download&id=16WEScARaSrzJpJkyGuOUxDF95eUwGyET";
