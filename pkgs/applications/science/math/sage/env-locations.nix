{ writeTextFile, pari_data, pari, singular, maxima-ecl, conway_polynomials
, graphs, elliptic_curves, polytopes_db, gap, ecl, combinatorial_designs, jmol
, mathjax, three, cysignals }:
