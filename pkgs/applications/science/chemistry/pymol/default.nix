{ stdenv, fetchurl, makeDesktopItem, python3, python3Packages, glew, freeglut, libpng, libxml2, tk, freetype, msgpack
}:
...
in python3Packages.buildPythonApplication {
  ...
  src = fetchurl {
    url =
      "mirror://sourceforge/project/pymol/pymol/${ver_maj}/pymol-v${version}.tar.bz2";
    sha256 = "1qpacd5w4r9a0nm5iqmkd92ym3ai00dp7v61cwd6jgakk6wfps3s";
  };

  buildInputs =
    [ python3Packages.numpy glew freeglut libpng libxml2 tk freetype msgpack ];
