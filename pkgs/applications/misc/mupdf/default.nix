{ stdenv, lib, fetchurl, fetchpatch, pkgconfig, freetype, harfbuzz, openjpeg, jbig2dec, libjpeg, darwin, enableX11 ?
  true, libX11, libXext, libXi, libXrandr, enableCurl ?
    true, curl, openssl, enableGL ? true, freeglut, libGLU }:
...
let
  ...
  openJpegVersion = with stdenv;
    ...
    (lib.lists.take 2 (lib.splitString "." (lib.getVersion openjpeg)));
  ...
  patches =
    ...
    [
      (fetchpatch {
        name = "CVE-2018-18662";
        url =
          "http://git.ghostscript.com/?p=mupdf.git;a=patch;h=164ddc22ee0d5b63a81d5148f44c37dd132a9356";
