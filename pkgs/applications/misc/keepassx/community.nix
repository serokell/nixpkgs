...
stdenv.mkDerivation rec {
  ...
  '';
  NIX_LDFLAGS =
    stdenv.lib.optionalString stdenv.isDarwin "-rpath ${libargon2}/lib";
  ...
  meta = {
    description =
      "Password manager to store your passwords safely and auto-type them into your everyday websites and applications";
    longDescription =
