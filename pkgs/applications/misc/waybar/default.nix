...
stdenv.mkDerivation rec {
  ...
  buildInputs = with stdenv.lib;
    ...
    ++ optional pulseSupport libpulseaudio ++ optional nlSupport libnl
    ++ optional udevSupport udev ++ optional swaySupport sway
    ++ optional mpdSupport mpd_clientlib;

  mesonFlags = (stdenv.lib.mapAttrsToList (option: enable:
