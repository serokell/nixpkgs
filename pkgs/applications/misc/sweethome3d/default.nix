...
let
  ...
  mkSweetHome3D =
    ...
    stdenv.mkDerivation rec {
      ...
      buildInputs =
        [ ant jdk jre makeWrapper p7zip gtk3 gsettings-desktop-schemas ];
      ...
      installPhase = ''
        ...
        makeWrapper ${jre}/bin/java $out/bin/$exec \
          ...
          --add-flags "-jar $out/share/java/${module}-${version}.jar -cp $out/share/java/Furniture.jar:$out/share/java/Textures.jar:$out/share/java/Help.jar -d${
...
in rec {
  ...
  application = mkSweetHome3D rec {
    ...
    src = fetchsvn {
      url = "https://svn.code.sf.net/p/sweethome3d/code/tags/V_" + d2u version
        + "/SweetHome3D/";
