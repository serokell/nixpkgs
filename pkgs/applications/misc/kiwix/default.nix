...
let
  xulrunner64_tar = fetchurl {
    url =
      "http://download.kiwix.org/dev/xulrunner-29.0.en-US.linux-x86_64.tar.bz2";
    sha256 = "0i3m30gm5z7qmas14id6ypvbmnb2k7jhz8aby2wz5vvv49zqmx3s";
  };
  xulrunnersdk64_tar = fetchurl {
    url =
      "http://download.kiwix.org/dev/xulrunner-29.0.en-US.linux-x86_64.sdk.tar.bz2";
    sha256 = "0z90v7c4mq15g5klmsj8vs2r10fbygj3qzynx4952hkv8ihw8n3a";
  };
  xulrunner32_tar = fetchurl {
    url =
      "http://download.kiwix.org/dev/xulrunner-29.0.en-US.linux-i686.tar.bz2";
    sha256 = "0yln6pxz8f6b9wm9124sx049z8mgi17lgd63rcv2hnix825y8gjb";
  };
  xulrunnersdk32_tar = fetchurl {
    url =
      "http://download.kiwix.org/dev/xulrunner-29.0.en-US.linux-i686.sdk.tar.bz2";
    sha256 = "1h9vcbvf8wgds6i2z20y7krpys0mqsqhv1ijyfljanp6vyll9fvi";
  };

  xulrunner = if stdenv.hostPlatform.system == "x86_64-linux" then {
    tar = xulrunner64_tar;
    sdk = xulrunnersdk64_tar;
  } else {
    tar = xulrunner32_tar;
    sdk = xulrunnersdk32_tar;
  };
...
in stdenv.mkDerivation rec {
  ...
  configureFlags = [ "--disable-static" "--disable-staticbins" ];
  ...
  meta = {
    ...
    knownVulnerabilities = [ "CVE-2015-1032" ];
  };
}
