...
rec {
  dockerGen = { version, rev, sha256, runcRev, runcSha256, containerdRev
    ...
    in stdenv.mkDerivation ((optionalAttrs (stdenv.isLinux) rec {

      inherit docker-runc docker-containerd docker-proxy docker-tini;

      DOCKER_BUILDTAGS = [ ] ++ optional (systemd != null) [ "journald" ]
      ...
      buildInputs = [ makeWrapper removeReferencesTo go-md2man go libtool ]
