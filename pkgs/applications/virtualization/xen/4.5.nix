  ...
  xenfiles = optionalAttrs withInternalQemu {
    "qemu-xen" = {
      ...
      patches = [
        ...
        (xsaPatch {
          name =
            "209-qemuu/0001-display-cirrus-ignore-source-pitch-value-as-needed-i";
          sha256 = "1xvxzsrsq05fj6szjlpbgg4ia3cw54dn5g7xzq1n1dymbhv606m0";
        })
        (xsaPatch {
          name =
            "209-qemuu/0002-cirrus-add-blit_is_unsafe-call-to-cirrus_bitblt_cput";
    ...
    "xen-libhvm-dir-remote" = {
      src = fetchgit {
        ...
        sha256 =
          "9ba97c39a00a54c154785716aa06691d312c99be498ebbc00dc3769968178ba8";
      };
      buildPhase = ''
        make
        cd biospt
