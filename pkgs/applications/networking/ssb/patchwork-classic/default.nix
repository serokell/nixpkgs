...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/ssbc/patchwork-classic-electron/releases/download/v2.12.0/ssb-patchwork-electron_2.12.0_linux-amd64.deb";
  ...
  meta = with stdenv.lib; {
    description =
      "Electron wrapper for Patchwork Classic: run as a desktop app outside the browser";
