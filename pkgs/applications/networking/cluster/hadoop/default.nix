...
, coreutils, glibc, protobuf2_5, fuse, snappy, zlib, bzip2, openssl }:
...
let
  common = { version, sha256, dependencies-sha256, tomcat }:
    let
      ...
      binary-distributon = stdenv.mkDerivation rec {
        ...
        src = fetchurl {
          url =
            "mirror://apache/hadoop/common/hadoop-${version}/hadoop-${version}-src.tar.gz";
          inherit sha256;
        };
        ...
        mavenFlags =
          "-Drequire.snappy -Drequire.bzip2 -DskipTests -Pdist,native -e";
        buildPhase = ''
          ...
          patchelf --set-rpath ${
            stdenv.lib.makeLibraryPath [ glibc ]
          } hadoop-dist/target/hadoop-${version}/lib/native/libhadoop.so.1.0.0
          patchelf --set-rpath ${
            stdenv.lib.makeLibraryPath [ glibc ]
          } hadoop-dist/target/hadoop-${version}/lib/native/libhdfs.so.0.0.0
        '';
  ...
  tomcat_6_0_48 = rec {
    ...
    src = fetchurl {
      ...
      url =
        "https://archive.apache.org/dist/tomcat/tomcat-6/v${version}/bin/apache-tomcat-${version}.tar.gz";
...
in {
  hadoop_2_7 = common {
    ...
    dependencies-sha256 =
      "1lsr9nvrynzspxqcamb10d596zlnmnfpxhkd884gdiva0frm0b1r";
  ...
  hadoop_2_8 = common {
    ...
    dependencies-sha256 =
      "1j4f461487fydgr5978nnm245ksv4xbvskfr8pbmfhcyss6b7w03";
    tomcat = tomcat_6_0_48;
  };
  hadoop_2_9 = common {
    version = "2.9.1";
    ...
    dependencies-sha256 =
      "1d5i8jj5y746rrqb9lscycnd7acmxlkz64ydsiyqsh5cdqgy2x7x";
    tomcat = tomcat_6_0_48;
  };
  hadoop_3_0 = common {
    version = "3.0.3";
    ...
    dependencies-sha256 =
      "1kzkna9ywacm2m1cirj9cyip66bgqjhid2xf9rrhq6g10lhr8j9m";
    tomcat = null;
  };
  hadoop_3_1 = common {
    version = "3.1.1";
    ...
    dependencies-sha256 =
      "1q63jsxg3d31x0p8hvhpvbly2b07almyzsbhwphbczl3fhlqgiwn";
    tomcat = null;
  };
}
