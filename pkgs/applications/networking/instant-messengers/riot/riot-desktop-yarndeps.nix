  ...
  packages = [
...

    {
      ...
      path = fetchurl {
        name = "electron_store___electron_store_2.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/electron-store/-/electron-store-2.0.0.tgz";
...

    {
      ...
      path = fetchurl {
        name = "electron_window_state___electron_window_state_4.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/electron-window-state/-/electron-window-state-4.1.1.tgz";
...

    {
      ...
      path = fetchurl {
        name = "load_bmfont___load_bmfont_1.4.0.tgz";
        url =
          "https://registry.yarnpkg.com/load-bmfont/-/load-bmfont-1.4.0.tgz";
...

    {
      ...
      path = fetchurl {
        name = "object_keys___object_keys_1.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/object-keys/-/object-keys-1.1.0.tgz";
...

    {
      ...
      path = fetchurl {
        name = "parse_headers___parse_headers_2.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/parse-headers/-/parse-headers-2.0.2.tgz";
