{ stdenv, fetchurl, pkgconfig, libxslt, telepathy-glib, libxml2, dbus-glib, dbus, sqlite, libsoup, libnice, gnutls
}:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://telepathy.freedesktop.org/releases/telepathy-gabble/${name}.tar.gz";
