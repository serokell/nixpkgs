{ stdenv, fetchFromGitHub, zlib, ocaml, dune, ocamlfuse, findlib, gapi_ocaml, ocaml_sqlite3, camlidl
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ zlib ocaml ocamlfuse findlib gapi_ocaml ocaml_sqlite3 camlidl ];
