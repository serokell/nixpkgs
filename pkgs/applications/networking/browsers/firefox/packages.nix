...
in rec {
  ...
  firefox = common rec {
    ...
    src = fetchurl {
      url =
        "mirror://mozilla/firefox/releases/${ffversion}/source/firefox-${ffversion}.source.tar.xz";
      sha512 =
        "0pg8ww2ldlvdlri0zrzv20x69x00gxshr4afq62pnz7rgrnppkdd0pw5snflisgvpxq1syxcrg5750wz1k4bfjwnyq47jk9h3fzddpw";
    };

    patches = [ ./no-buildconfig-ffx65.patch ];
  ...
  firefox-esr-52 = (common rec {
    ...
    stdenv = overrideCC gccStdenv
      gcc6; # gcc7 fails with "undefined reference to `__divmoddi4'"
    gtk3Support = false;
  };
  ...
  firefox-esr-60 = common rec {
    ...
    src = fetchurl {
      url =
        "mirror://mozilla/firefox/releases/${ffversion}/source/firefox-${ffversion}.source.tar.xz";
      sha512 =
        "0332b6049b97e488e55a3b9540baad3bd159e297084e9a625b8492497c73f86eb3e144219dabc5e9f2c2e4a27630d83d243c919cd4f86b7f59f47133ed3afc54";
    };
  ...
  firefox-esr-68 = common rec {
    ...
    src = fetchurl {
      url =
        "mirror://mozilla/firefox/releases/${ffversion}/source/firefox-${ffversion}.source.tar.xz";
      sha512 =
        "29iqxxwkz2zgk2ppgq05w0bhs8c0938gina5s8brmwn6zn15nv379pa82a9djpzjryl6c5ff0hk0z7gx6n3xvf7w7ky9010h9il0kbg";
    };
