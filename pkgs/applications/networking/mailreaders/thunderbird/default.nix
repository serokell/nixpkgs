...
enableOfficialBranding ? false, makeDesktopItem }:
...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha512 =
      "1cd1ps4r70bnxn9kydljsp776dazfzfsghc5zwp1xz6p3cwb9g0gybj677sac7y3ma2wsq1xbqk20q35n7gjz3k1zzhmpxyii558rdl";
  };
  ...
  patches = [
    ...
    (fetchurl {
      ...
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/deny_missing_docs.patch"
  ...
  configureFlags =
    ...
    ++ lib.optionals
    (lib.versionAtLeast version "56" && !stdenv.hostPlatform.isi686) [
