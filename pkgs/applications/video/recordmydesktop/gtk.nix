{ stdenv, lib, fetchsvn, recordmydesktop, autoreconfHook, pkgconfig, pythonPackages, jack2, xwininfo
}:
...
in stdenv.mkDerivation rec {
  ...
  src = fetchsvn {
    url =
      "https://recordmydesktop.svn.sourceforge.net/svnroot/recordmydesktop/trunk/gtk-recordmydesktop";
  ...
  buildInputs = with pythonPackages; [ python pygtk wrapPython ];
