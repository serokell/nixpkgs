...
python3.pkgs.buildPythonApplication rec {
  ...
  src = fetchurl {
    url =
      "https://launchpad.net/kazam/stable/${version}/+download/kazam-${version}.tar.gz";
  ...
  patches = [
    ...
    (fetchurl {
      url =
        "https://sources.debian.org/data/main/k/kazam/1.4.5-2/debian/patches/configparser_api_changes.patch";
