...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    url =
      "https://www.barco.com/services/website/de/TdeFiles/Download?FileNumber=R33050020&TdeType=3&MajorVersion=01&MinorVersion=07&PatchVersion=00&BuildVersion=033";
    sha256 = "0h4jqidqvk4xkaky5bizi7ilz4qzl2mh68401j21y3djnzx09br3";
  };

  nativeBuildInputs =
    [ autoPatchelfHook binutils-unwrapped gnutar rpmextract unzip ];
  buildInputs = [
    alsaLib
    libav_0_8
    libnotify
  ...
  postUnpack = let
    rpmArch = if stdenv.hostPlatform.isx86_32 then
      "i386"
