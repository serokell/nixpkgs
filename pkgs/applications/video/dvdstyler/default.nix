...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "mirror://sourceforge/project/dvdstyler/dvdstyler/${version}/${srcName}.tar.bz2";
    sha256 = "1rz69vrfqz9sma9cm1mnvkd11zq3is53lc3m3hcphr02vs69s53m";
  };

  nativeBuildInputs = [ pkgconfig ];

  packagesToBinPath = [ cdrtools dvdauthor dvdplusrwtools ];
  ...
  buildInputs = [
    ...
    zip
    makeWrapper
  ] ++ packagesToBinPath ++ optionals dvdisasterSupport [ dvdisaster ]
