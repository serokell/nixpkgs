...
let
  ...
  codecs_src = let dir = "http://www.mplayerhq.hu/MPlayer/releases/codecs/";
...
in stdenv.mkDerivation rec {
  ...
  installTargets = [ "install" ]
    ++ stdenv.lib.optional x11Support "install-gui";
