{ stdenv, fetchurl, fetchpatch, cmake, pkgconfig, xorg, libjpeg, libpng, fontconfig, freetype, pam, dbus, makeWrapper
}:
...
stdenv.mkDerivation rec {
  ...
  patches = [ # Allow the paths of the configuration file and theme directory to
    # be set at runtime.
    ./runtime-paths.patch
    ...
    url =
      "https://raw.githubusercontent.com/gentoo/musl/8eddda8072add075ebf56cf6d288bc1450d6b5f8/x11-misc/slim/files/slim-1.3.6-add-missing-libgen_h.patch";
  ...
  meta = {
    homepage =
      "https://sourceforge.net/projects/slim.berlios/"; # berlios shut down; I found no replacement yet
