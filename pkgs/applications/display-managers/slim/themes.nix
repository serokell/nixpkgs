...
let
  buildTheme = { fullName, src, version ? "testing" }:
...
in {
  ...
  capernoited = buildTheme {
    ...
    src = fetchurl {
      ...
      sha256 =
        "fb9163c6a2656d60f088dc4f2173aa7556a6794495122acfa7d3be7182f16b41";
    };
  };
  ...
  flower2 = buildTheme {
    ...
    src = fetchurl {
      ...
      sha256 =
        "840faf6459ffd6c2c363160c85cb98000717f9a425102976336f5d8f68ed95ee";
    };
  };
  ...
  gentooSimple = buildTheme {
    ...
    src = fetchurl {
      ...
      sha256 =
        "27c8614cc930ca200acf81f1192febc102501744939d5cbe997141e37c96d8c2";
    };
  };
  ...
  mindlock = buildTheme {
    ...
    src = fetchurl {
      ...
      sha256 =
        "99a6e6acd55bf55ece18a3f644299517b71c1adc49efd87ce2d7e654fb67033c";
    };
  };
  ...
  parallelDimensions = buildTheme {
    ...
    src = fetchurl {
      ...
      sha256 =
        "2b17c3e6d3967a6a0744e20e6e05c9d3938f4ef04c62d49ddbd416bc4743046f";
    };
  };
