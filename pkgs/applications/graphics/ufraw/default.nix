...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ gtk2 gtkimageview bzip2 zlib libjpeg libtiff cfitsio exiv2 lcms2 lensfun ]
    ++ stdenv.lib.optional withGimpPlugin gimp;

  configureFlags =
    [ "--enable-extras" "--enable-dst-correction" "--enable-contrast" ]
  ...
  meta = {
    ...
    platforms = stdenv.lib.platforms.gnu
      ++ stdenv.lib.platforms.linux; # needs GTK+
  };
}
