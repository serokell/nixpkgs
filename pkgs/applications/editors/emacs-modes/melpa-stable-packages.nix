...
let
  imported =
    import ./melpa-stable-generated.nix { inherit (self) callPackage; };

  super = imported;

  dontConfigure = pkg:
    pkg.override (args: {
      melpaBuild = drv: args.melpaBuild (drv // { configureScript = "true"; });
    });
  ...
  overrides = {
    ...
    airline-themes =
      super.airline-themes.override { inherit (self.melpaPackages) powerline; };
    ...
    evil-search-highlight-persist =
      markBroken super.evil-search-highlight-persist;
    ...
    magit = (super.magit.override {
      ...
      nativeBuildInputs = (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
    });
...
in melpaStablePackages // { inherit melpaStablePackages; }
