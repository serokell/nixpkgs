...
in rec {
  ...
  deps.dbus_macros."0.0.6" = { dbus = "0.4.1"; };
  deps.dlib."0.3.1" = { libloading = "0.3.4"; };
  deps.dlib."0.4.1" = { libloading = "0.5.0"; };
  deps.dtoa."0.4.3" = { };
  ...
  deps.getopts."0.2.18" = { unicode_width = "0.1.5"; };
  deps.gio_sys."0.4.0" = {
    bitflags = "0.9.1";
    glib_sys = "0.4.0";
    gobject_sys = "0.4.0";
  ...
  deps.itoa."0.3.4" = { };
  deps.json_macro."0.1.1" = { rustc_serialize = "0.3.24"; };
  ...
  deps.log."0.3.9" = { log = "0.4.6"; };
  deps.log."0.4.6" = { cfg_if = "0.1.6"; };
  ...
  deps.num_traits."0.1.43" = { num_traits = "0.2.6"; };
  ...
  deps.phf."0.7.23" = { phf_shared = "0.7.23"; };
  ...
  deps.phf_shared."0.7.23" = { siphasher = "0.2.3"; };
  ...
  deps.rustc_version."0.1.7" = { semver = "0.1.20"; };
  deps.rustwlc."0.7.0" = {
    bitflags = "0.7.0";
    libc = "0.2.44";
    wayland_sys = "0.6.0";
  ...
  deps.wayland_scanner."0.12.5" = { xml_rs = "0.7.0"; };
  ...
  deps.xml_rs."0.7.0" = { bitflags = "1.0.4"; };
}
