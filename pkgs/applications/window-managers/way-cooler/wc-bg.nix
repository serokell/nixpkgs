...
in rec {
  wc_bg = f:
    wc_bg_0_3_0 { features = wc_bg_0_3_0_features { wc_bg_0_3_0 = f; }; };
  ansi_term_0_9_0_ =
  ...
  atty_0_2_3_ = { dependencies ? [ ], buildDependencies ? [ ], features ? [ ] }:
    buildRustCrate {
      crateName = "atty";
      version = "0.2.3";
  ...
  dtoa_0_4_2_ = { dependencies ? [ ], buildDependencies ? [ ], features ? [ ] }:
    buildRustCrate {
      crateName = "dtoa";
      version = "0.4.2";
  ...
  itoa_0_3_4_ = { dependencies ? [ ], buildDependencies ? [ ], features ? [ ] }:
    buildRustCrate {
      crateName = "itoa";
      version = "0.3.4";
      authors = [ "David Tolnay <dtolnay@gmail.com>" ];
  ...
  clap_2_26_2 = { features ? (clap_2_26_2_features { }) }:
    clap_2_26_2_ {
      dependencies = mapFeatures features
        ([ bitflags_0_9_1 textwrap_0_8_0 unicode_width_0_1_4 vec_map_0_8_0 ]
          ++ (if features.clap_2_26_2.ansi_term or false then
            [ ansi_term_0_9_0 ]
          else
            [ ]) ++ (if features.clap_2_26_2.atty or false then
              [ atty_0_2_3 ]
            else
              [ ]) ++ (if features.clap_2_26_2.strsim or false then
                [ strsim_0_6_0 ]
              else
                [ ]) ++ (if features.clap_2_26_2.term_size or false then
                  [ term_size_0_3_0 ]
                else
                  [ ]));
      features = mkFeatures (features.clap_2_26_2 or { });
    };
  clap_2_26_2_features = f:
    updateFeatures f (rec {
      ansi_term_0_9_0.default = true;
      atty_0_2_3.default = true;
      bitflags_0_9_1.default = true;
      clap_2_26_2.ansi_term = (f.clap_2_26_2.ansi_term or false)
        || (f.clap_2_26_2.color or false) || (clap_2_26_2.color or false);
      clap_2_26_2.atty = (f.clap_2_26_2.atty or false)
        || (f.clap_2_26_2.color or false) || (clap_2_26_2.color or false);
      clap_2_26_2.clippy = (f.clap_2_26_2.clippy or false)
        || (f.clap_2_26_2.lints or false) || (clap_2_26_2.lints or false);
      clap_2_26_2.color = (f.clap_2_26_2.color or false)
        || (f.clap_2_26_2.default or false) || (clap_2_26_2.default or false);
      clap_2_26_2.default = (f.clap_2_26_2.default or true);
      clap_2_26_2.strsim = (f.clap_2_26_2.strsim or false)
        || (f.clap_2_26_2.suggestions or false)
        || (clap_2_26_2.suggestions or false);
      clap_2_26_2.suggestions = (f.clap_2_26_2.suggestions or false)
        || (f.clap_2_26_2.default or false) || (clap_2_26_2.default or false);
      clap_2_26_2.term_size = (f.clap_2_26_2.term_size or false)
        || (f.clap_2_26_2.wrap_help or false)
        || (clap_2_26_2.wrap_help or false);
      clap_2_26_2.wrap_help = (f.clap_2_26_2.wrap_help or false)
        || (f.clap_2_26_2.default or false) || (clap_2_26_2.default or false);
      clap_2_26_2.yaml = (f.clap_2_26_2.yaml or false)
        || (f.clap_2_26_2.doc or false) || (clap_2_26_2.doc or false);
      clap_2_26_2.yaml-rust = (f.clap_2_26_2.yaml-rust or false)
        || (f.clap_2_26_2.yaml or false) || (clap_2_26_2.yaml or false);
  ...
  fuchsia_zircon_0_2_1 = { features ? (fuchsia_zircon_0_2_1_features { }) }:
    fuchsia_zircon_0_2_1_ {
  ...
  fuchsia_zircon_sys_0_2_0 =
    { features ? (fuchsia_zircon_sys_0_2_0_features { }) }:
    fuchsia_zircon_sys_0_2_0_ {
  ...
  fuchsia_zircon_sys_0_2_0_features = f:
    updateFeatures f (rec {
      ...
      fuchsia_zircon_sys_0_2_0.default =
        (f.fuchsia_zircon_sys_0_2_0.default or true);
  ...
  itoa_0_3_4 = { features ? (itoa_0_3_4_features { }) }:
    itoa_0_3_4_ { features = mkFeatures (features.itoa_0_3_4 or { }); };
  ...
  lazy_static_0_2_9 = { features ? (lazy_static_0_2_9_features { }) }:
    lazy_static_0_2_9_ {
      dependencies = mapFeatures features ([ ]);
      features = mkFeatures (features.lazy_static_0_2_9 or { });
    };
  lazy_static_0_2_9_features = f:
    updateFeatures f (rec {
      lazy_static_0_2_9.default = (f.lazy_static_0_2_9.default or true);
      lazy_static_0_2_9.nightly = (f.lazy_static_0_2_9.nightly or false)
        || (f.lazy_static_0_2_9.spin_no_std or false)
        || (lazy_static_0_2_9.spin_no_std or false);
      lazy_static_0_2_9.spin = (f.lazy_static_0_2_9.spin or false)
        || (f.lazy_static_0_2_9.spin_no_std or false)
        || (lazy_static_0_2_9.spin_no_std or false);
    }) [ ];
  libc_0_2_32 = { features ? (libc_0_2_32_features { }) }:
    libc_0_2_32_ { features = mkFeatures (features.libc_0_2_32 or { }); };
  libc_0_2_32_features = f:
    updateFeatures f (rec {
      libc_0_2_32.default = (f.libc_0_2_32.default or true);
      libc_0_2_32.use_std = (f.libc_0_2_32.use_std or false)
        || (f.libc_0_2_32.default or false) || (libc_0_2_32.default or false);
    }) [ ];
  ...
  num_bigint_0_1_40 = { features ? (num_bigint_0_1_40_features { }) }:
    num_bigint_0_1_40_ {
      dependencies = mapFeatures features
        ([ num_integer_0_1_35 num_traits_0_1_40 ]
  ...
  num_iter_0_1_34 = { features ? (num_iter_0_1_34_features { }) }:
    num_iter_0_1_34_ {
      dependencies =
        mapFeatures features ([ num_integer_0_1_35 num_traits_0_1_40 ]);
    };
  ...
  num_traits_0_1_40 = { features ? (num_traits_0_1_40_features { }) }:
    num_traits_0_1_40_ { };
  num_traits_0_1_40_features = f:
    updateFeatures f (rec {
      num_traits_0_1_40.default = (f.num_traits_0_1_40.default or true);
    }) [ ];
  num_cpus_1_7_0 = { features ? (num_cpus_1_7_0_features { }) }:
    num_cpus_1_7_0_ { dependencies = mapFeatures features ([ libc_0_2_32 ]); };
  num_cpus_1_7_0_features = f:
    updateFeatures f (rec {
      libc_0_2_32.default = true;
  ...
  rand_0_3_17 = { features ? (rand_0_3_17_features { }) }:
    rand_0_3_17_ {
      dependencies = mapFeatures features ([ libc_0_2_32 ])
        ++ (if kernel == "fuchsia" then
          mapFeatures features ([ fuchsia_zircon_0_2_1 ])
        else
          [ ]);
      features = mkFeatures (features.rand_0_3_17 or { });
    };
  rand_0_3_17_features = f:
    updateFeatures f (rec {
      fuchsia_zircon_0_2_1.default = true;
      libc_0_2_32.default = true;
      rand_0_3_17.default = (f.rand_0_3_17.default or true);
      rand_0_3_17.i128_support = (f.rand_0_3_17.i128_support or false)
        || (f.rand_0_3_17.nightly or false) || (rand_0_3_17.nightly or false);
  ...
  rayon_core_1_2_1_features = f:
    updateFeatures f (rec {
      ...
      lazy_static_0_2_9_features
      libc_0_2_32_features
      num_cpus_1_7_0_features
      rand_0_3_17_features
    ];
  redox_syscall_0_1_31 = { features ? (redox_syscall_0_1_31_features { }) }:
    redox_syscall_0_1_31_ { };
  redox_syscall_0_1_31_features = f:
    updateFeatures f (rec {
  ...
  tempfile_2_2_0 = { features ? (tempfile_2_2_0_features { }) }:
    tempfile_2_2_0_ {
      dependencies = mapFeatures features ([ rand_0_3_17 ])
        ++ (if kernel == "redox" then
          mapFeatures features ([ redox_syscall_0_1_31 ])
        else
          [ ]) ++ (if (kernel == "linux" || kernel == "darwin") then
            mapFeatures features ([ libc_0_2_32 ])
          else
  ...
  termion_1_5_1 = { features ? (termion_1_5_1_features { }) }:
    termion_1_5_1_ {
      dependencies = (if !(kernel == "redox") then
        ...
        [ ]) ++ (if kernel == "redox" then
          mapFeatures features ([ redox_syscall_0_1_31 redox_termios_0_1_1 ])
        else
          [ ]);
    };
  ...
  textwrap_0_8_0 = { features ? (textwrap_0_8_0_features { }) }:
    textwrap_0_8_0_ {
      dependencies =
        mapFeatures features ([ term_size_0_3_0 unicode_width_0_1_4 ]);
    };
  textwrap_0_8_0_features = f:
    updateFeatures f (rec {
      term_size_0_3_0.default = true;
  ...
  way_cooler_client_helpers_0_1_0 =
    ...
    way_cooler_client_helpers_0_1_0_ {
      dependencies =
        mapFeatures features ([ wayland_client_0_9_10 wayland_sys_0_9_10 ]);
    };
  ...
  wayland_client_0_9_10 = { features ? (wayland_client_0_9_10_features { }) }:
    wayland_client_0_9_10_ {
      dependencies = mapFeatures features ([
        bitflags_0_9_1
        libc_0_2_32
  ...
  wayland_client_0_9_10_features = f:
    updateFeatures f (rec {
      bitflags_0_9_1.default = true;
      libc_0_2_32.default = true;
      wayland_client_0_9_10.cursor = (f.wayland_client_0_9_10.cursor or false)
      ...
      wayland_client_0_9_10.egl = (f.wayland_client_0_9_10.egl or false)
        || (f.wayland_client_0_9_10.default or false)
        || (wayland_client_0_9_10.default or false);
      wayland_scanner_0_9_10.default = true;
      wayland_sys_0_9_10.client = true;
      wayland_sys_0_9_10.cursor = (f.wayland_sys_0_9_10.cursor or false)
        || (wayland_client_0_9_10.cursor or false)
        || (f.wayland_client_0_9_10.cursor or false);
      wayland_sys_0_9_10.default = true;
      wayland_sys_0_9_10.dlopen = (f.wayland_sys_0_9_10.dlopen or false)
        || (wayland_client_0_9_10.dlopen or false)
        || (f.wayland_client_0_9_10.dlopen or false);
      wayland_sys_0_9_10.egl = (f.wayland_sys_0_9_10.egl or false)
        || (wayland_client_0_9_10.egl or false)
        || (f.wayland_client_0_9_10.egl or false);
    }) [
      bitflags_0_9_1_features
      libc_0_2_32_features
      wayland_sys_0_9_10_features
      wayland_scanner_0_9_10_features
    ];
  wayland_scanner_0_9_10 = { features ? (wayland_scanner_0_9_10_features { }) }:
    wayland_scanner_0_9_10_ {
      dependencies = mapFeatures features ([ xml_rs_0_6_1 ]);
    };
  wayland_scanner_0_9_10_features = f:
    updateFeatures f (rec {
      wayland_scanner_0_9_10.default =
        (f.wayland_scanner_0_9_10.default or true);
      xml_rs_0_6_1.default = true;
    }) [ xml_rs_0_6_1_features ];
  wayland_sys_0_9_10 = { features ? (wayland_sys_0_9_10_features { }) }:
    wayland_sys_0_9_10_ {
      dependencies = mapFeatures features ([ dlib_0_3_1 ]
        ++ (if features.wayland_sys_0_9_10.lazy_static or false then
          [ lazy_static_0_2_9 ]
        else
          [ ]));
      features = mkFeatures (features.wayland_sys_0_9_10 or { });
    };
  wayland_sys_0_9_10_features = f:
    updateFeatures f (rec {
  ...
  wc_bg_0_3_0_features = f:
    updateFeatures f (rec {
      ...
      byteorder_0_5_3_features
      clap_2_26_2_features
      image_0_10_4_features
      tempfile_2_2_0_features
      way_cooler_client_helpers_0_1_0_features
      wayland_client_0_9_10_features
      wayland_sys_0_9_10_features
      wayland_scanner_0_9_10_features
    ];
  ...
  xml_rs_0_6_1 = { features ? (xml_rs_0_6_1_features { }) }:
    xml_rs_0_6_1_ { dependencies = mapFeatures features ([ bitflags_0_9_1 ]); };
  xml_rs_0_6_1_features = f:
    updateFeatures f (rec {
      bitflags_0_9_1.default = true;
