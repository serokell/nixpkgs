...
let
  ...
  mist = stdenv.lib.appendToName "unwrapped" (stdenv.mkDerivation {
    ...
    src = {
      i686-linux = fetchurl {
        url =
          "https://github.com/ethereum/mist/releases/download/v${version}/Mist-linux32-${urlVersion}.zip";
        sha256 = "1ffzp9aa0g6w3d5pzp69fljk3sd51cbqdgxa1x16vj106sqm0gj7";
      };
      x86_64-linux = fetchurl {
        url =
          "https://github.com/ethereum/mist/releases/download/v${version}/Mist-linux64-${urlVersion}.zip";
...
in buildFHSUserEnv {
  ...
  targetPkgs = pkgs: with pkgs; [ mist ];
