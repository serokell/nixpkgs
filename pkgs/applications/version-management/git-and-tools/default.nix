...
let
  ...
  self = rec {
    ...
    gitSVN = lowPrio
      (appendToName "with-svn" (gitBase.override { svnSupport = true; }));
    ...
    git-annex-remote-dbx = callPackage ./git-annex-remote-dbx {
      inherit (python3Packages)
        buildPythonApplication fetchPypi dropbox annexremote humanfriendly;
    };
    ...
    hub = callPackage ./hub { inherit (darwin) Security; };
    ...
    svn2git = callPackage ./svn2git { git = gitSVN; };
