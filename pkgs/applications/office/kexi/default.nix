{ mkDerivation, lib, fetchurl, extra-cmake-modules, kdoctools, boost, qttools
, qtwebkit, breeze-icons, karchive, kcodecs, kcompletion, kconfig
...
, kproperty, kreport, lcms2, mysql, marble, postgresql }:
