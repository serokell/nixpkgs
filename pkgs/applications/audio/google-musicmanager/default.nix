{ stdenv, fetchurl, flac, expat, libidn, qtbase, qtwebkit, libvorbis }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://dl.google.com/linux/musicmanager/deb/pool/main/g/google-musicmanager-beta/${name}_amd64.deb";
