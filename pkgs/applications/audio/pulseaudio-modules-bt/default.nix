...
in stdenv.mkDerivation rec {
  ...
  patches = [ ./fix-install-path.patch ./fix-aac-defaults.patch ];

  nativeBuildInputs = [ pkgconfig patchelf cmake ];

  buildInputs = [ pulseaudio ffmpeg_4 fdk_aac libtool ldacbt bluez dbus sbc ];
