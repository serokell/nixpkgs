...
with self; {
  ...
  editres = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, xorgproto, libXt }:
    stdenv.mkDerivation {
      name = "editres-1.0.7";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  fontmiscethiopic = callPackage ({ stdenv, pkgconfig, fetchurl, mkfontscale }:
    stdenv.mkDerivation {
  ...
  fontxfree86type1 = callPackage ({ stdenv, pkgconfig, fetchurl, mkfontscale }:
    stdenv.mkDerivation {
  ...
  libXcursor = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXfixes, libXrender }:
    stdenv.mkDerivation {
  ...
  libXpresent = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11 }:
    stdenv.mkDerivation {
  ...
  libXrender = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11 }:
    stdenv.mkDerivation {
  ...
  libxkbfile = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11 }:
    stdenv.mkDerivation {
  ...
  setxkbmap = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libxkbfile }:
    stdenv.mkDerivation {
  ...
  viewres = callPackage ({ stdenv, pkgconfig, fetchurl, libXaw, libXmu, libXt }:
    stdenv.mkDerivation {
      name = "viewres-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xpr = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXmu, xorgproto }:
    stdenv.mkDerivation {
      name = "xpr-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
