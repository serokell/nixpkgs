...
lib.makeScope newScope (self:
  with self; {
    ...
    appres = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXt }:
        stdenv.mkDerivation {
          name = "appres-1.0.5";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    bdftopcf = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
        name = "bdftopcf-1.1";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    bitmap = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXaw
      , xbitmaps, libXmu, xorgproto, libXt }:
      stdenv.mkDerivation {
        name = "bitmap-1.0.9";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    editres = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu
      , xorgproto, libXt }:
      stdenv.mkDerivation {
        name = "editres-1.0.7";
        builder = ./builder.sh;
    ...
    encodings = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    fontadobe100dpi = callPackage
      ({ stdenv, pkgconfig, fetchurl, bdftopcf, fontutil, mkfontscale }:
        stdenv.mkDerivation {
    ...
    fontadobeutopiatype1 = callPackage
      ({ stdenv, pkgconfig, fetchurl, mkfontscale }:
        stdenv.mkDerivation {
    ...
    fontalias = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    fontarabicmisc = callPackage
      ({ stdenv, pkgconfig, fetchurl, bdftopcf, mkfontscale }:
        stdenv.mkDerivation {
    ...
    fontbhttf = callPackage ({ stdenv, pkgconfig, fetchurl, mkfontscale }:
      stdenv.mkDerivation {
    ...
    fontbhtype1 = callPackage ({ stdenv, pkgconfig, fetchurl, mkfontscale }:
      stdenv.mkDerivation {
    ...
    fontibmtype1 = callPackage ({ stdenv, pkgconfig, fetchurl, mkfontscale }:
      stdenv.mkDerivation {
    ...
    fontmiscmeltho = callPackage ({ stdenv, pkgconfig, fetchurl, mkfontscale }:
      stdenv.mkDerivation {
    ...
    fonttosfnt = callPackage
      ({ stdenv, pkgconfig, fetchurl, libfontenc, freetype, xorgproto }:
        stdenv.mkDerivation {
    ...
    fontutil = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    gccmakedep = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    iceauth = callPackage ({ stdenv, pkgconfig, fetchurl, libICE, xorgproto }:
      stdenv.mkDerivation {
        name = "iceauth-1.0.8";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    ico = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "ico-1.0.5";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    imake = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto }:
      stdenv.mkDerivation {
        name = "imake-1.0.8";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libAppleWM = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext }:
        stdenv.mkDerivation {
    ...
    libFS = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, xtrans }:
      stdenv.mkDerivation {
        name = "libFS-1.0.8";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libICE = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, xtrans }:
      stdenv.mkDerivation {
        name = "libICE-1.0.9";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libSM = callPackage
      ({ stdenv, pkgconfig, fetchurl, libICE, libuuid, xorgproto, xtrans }:
        stdenv.mkDerivation {
          name = "libSM-1.2.3";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libX11 = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libxcb, xtrans }:
        stdenv.mkDerivation {
          name = "libX11-1.6.7";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libXau = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto }:
      stdenv.mkDerivation {
        name = "libXau-1.0.9";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libXaw3d = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXext
      , libXmu, libXpm, xorgproto, libXt }:
      stdenv.mkDerivation {
        name = "libXaw3d-1.6.3";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libXcomposite = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXfixes }:
        stdenv.mkDerivation {
    ...
    libXcursor = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11
    ...
    libXdmcp = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto }:
      stdenv.mkDerivation {
        name = "libXdmcp-1.1.3";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libXext = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "libXext-1.3.4";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libXfixes = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11 }:
      stdenv.mkDerivation {
    ...
    libXfont2 = callPackage ({ stdenv, pkgconfig, fetchurl, libfontenc
      , xorgproto, freetype, xtrans, zlib }:
      stdenv.mkDerivation {
    ...
    libXi = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXfixes }:
        stdenv.mkDerivation {
          name = "libXi-1.7.9";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libXinerama = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libXext, xorgproto }:
        stdenv.mkDerivation {
    ...
    libXmu = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libXext, xorgproto, libXt }:
        stdenv.mkDerivation {
          name = "libXmu-1.1.3";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libXp = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXau, libXext }:
        stdenv.mkDerivation {
          name = "libXp-1.0.3";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libXpresent = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11 }:
        stdenv.mkDerivation {
    ...
    libXrandr = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXrender }:
        stdenv.mkDerivation {
    ...
    libXt = callPackage
      ({ stdenv, pkgconfig, fetchurl, libICE, xorgproto, libSM, libX11 }:
        stdenv.mkDerivation {
          name = "libXt-1.1.5";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libXtst = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXi }:
        stdenv.mkDerivation {
          name = "libXtst-1.2.3";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libXvMC = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXv }:
        stdenv.mkDerivation {
          name = "libXvMC-1.0.11";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    libfontenc = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, zlib }:
      stdenv.mkDerivation {
    ...
    libpciaccess = callPackage ({ stdenv, pkgconfig, fetchurl, zlib }:
      stdenv.mkDerivation {
    ...
    libpthreadstubs = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    libxcb = callPackage ({ stdenv, pkgconfig, fetchurl, libxslt
      , libpthreadstubs, libXau, xcbproto, libXdmcp, python }:
      stdenv.mkDerivation {
        name = "libxcb-1.13.1";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    libxshmfence = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto }:
      stdenv.mkDerivation {
    ...
    listres = callPackage
      ({ stdenv, pkgconfig, fetchurl, libXaw, libXmu, xorgproto, libXt }:
        stdenv.mkDerivation {
          name = "listres-1.0.4";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    lndir = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto }:
      stdenv.mkDerivation {
        name = "lndir-1.0.3";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    luit = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
        name = "luit-20190106";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    makedepend = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto }:
      stdenv.mkDerivation {
    ...
    mkfontscale = callPackage
      ({ stdenv, pkgconfig, fetchurl, libfontenc, freetype, xorgproto, zlib }:
        stdenv.mkDerivation {
    ...
    sessreg = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto }:
      stdenv.mkDerivation {
        name = "sessreg-1.1.1";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    setxkbmap = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libxkbfile }:
        stdenv.mkDerivation {
    ...
    smproxy = callPackage
      ({ stdenv, pkgconfig, fetchurl, libICE, libSM, libXmu, libXt }:
        stdenv.mkDerivation {
          name = "smproxy-1.0.6";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    transset = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "transset-1.0.2";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    utilmacros = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    viewres = callPackage
      ({ stdenv, pkgconfig, fetchurl, libXaw, libXmu, libXt }:
        stdenv.mkDerivation {
          name = "viewres-1.0.5";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    x11perf = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXext
      , libXft, libXmu, xorgproto, libXrender }:
      stdenv.mkDerivation {
        name = "x11perf-1.6.1";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xbacklight = callPackage ({ stdenv, pkgconfig, fetchurl, libxcb, xcbutil }:
      stdenv.mkDerivation {
    ...
    xbitmaps = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
        name = "xbitmaps-1.1.2";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xcalc = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, xorgproto, libXt }:
        stdenv.mkDerivation {
          name = "xcalc-1.1.0";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xcbproto = callPackage ({ stdenv, pkgconfig, fetchurl, python }:
      stdenv.mkDerivation {
        name = "xcb-proto-1.13";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xcbutil = callPackage
      ({ stdenv, pkgconfig, fetchurl, gperf, libxcb, xorgproto, m4 }:
        stdenv.mkDerivation {
          name = "xcb-util-0.4.0";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xcbutilerrors = callPackage
      ({ stdenv, pkgconfig, fetchurl, gperf, libxcb, xcbproto, xorgproto, m4 }:
        stdenv.mkDerivation {
    ...
    xcbutilimage = callPackage
      ({ stdenv, pkgconfig, fetchurl, gperf, libxcb, xcbutil, xorgproto, m4 }:
        stdenv.mkDerivation {
    ...
    xclock = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXft
      ...
      stdenv.mkDerivation {
        ...
        nativeBuildInputs = [ pkgconfig ];
        buildInputs =
          [ libX11 libXaw libXft libxkbfile libXmu xorgproto libXrender libXt ];
        meta.platforms = stdenv.lib.platforms.unix;
      }) { };

    xcmsdb = callPackage ({ stdenv, pkgconfig, fetchurl, libX11 }:
      stdenv.mkDerivation {
        name = "xcmsdb-1.0.5";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xconsole = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXaw
    ...
    xcursorgen = callPackage
      ({ stdenv, pkgconfig, fetchurl, libpng, libX11, libXcursor }:
        stdenv.mkDerivation {
    ...
    xcursorthemes = callPackage ({ stdenv, pkgconfig, fetchurl, libXcursor }:
      stdenv.mkDerivation {
    ...
    xdpyinfo = callPackage ({ stdenv, pkgconfig, fetchurl, libdmx, libX11
      , libxcb, libXcomposite, libXext, libXi, libXinerama, xorgproto
      , libXrender, libXtst, libXxf86dga, libXxf86misc, libXxf86vm }:
      stdenv.mkDerivation {
        name = "xdpyinfo-1.3.2";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xdriinfo = callPackage
      ({ stdenv, pkgconfig, fetchurl, libGL, xorgproto, libX11 }:
        stdenv.mkDerivation {
          name = "xdriinfo-1.0.6";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xev = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXrandr }:
        stdenv.mkDerivation {
          name = "xev-1.2.3";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xf86inputjoystick = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, xorgserver }:
        stdenv.mkDerivation {
    ...
    xf86inputlibinput = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libinput, xorgserver }:
        stdenv.mkDerivation {
    ...
    xf86inputvmmouse = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, udev, xorgserver }:
        stdenv.mkDerivation {
    ...
    xf86inputvoid = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgserver, xorgproto }:
        stdenv.mkDerivation {
    ...
    xf86videoamdgpu = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto
      , mesa, libGL, libdrm, udev, xorgserver }:
      stdenv.mkDerivation {
    ...
    xf86videoapm = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libpciaccess, xorgserver }:
        stdenv.mkDerivation {
    ...
    xf86videoati = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, mesa
      ...
      stdenv.mkDerivation {
        ...
        nativeBuildInputs = [ pkgconfig ];
        buildInputs =
          [ xorgproto mesa libGL libdrm udev libpciaccess xorgserver ];
        meta.platforms = stdenv.lib.platforms.unix;
      }) { };
    ...
    xf86videoglint = callPackage
      ({ stdenv, pkgconfig, fetchurl, libpciaccess, xorgproto, xorgserver }:
        stdenv.mkDerivation {
    ...
    xf86videointel = callPackage ({ stdenv, pkgconfig, fetchurl, cairo
      , xorgproto, libdrm, libpng, udev, libpciaccess, libX11, xcbutil, libxcb
      , libXcursor, libXdamage, libXext, libXfixes, xorgserver, libXrandr
      , libXrender, libxshmfence, libXtst, libXvMC }:
      stdenv.mkDerivation {
    ...
    xf86videoomap = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libdrm, xorgserver }:
        stdenv.mkDerivation {
    ...
    xf86videor128 = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto
      , libdrm, libpciaccess, xorgserver }:
      stdenv.mkDerivation {
    ...
    xf86videotdfx = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto
      , libdrm, libpciaccess, xorgserver }:
      stdenv.mkDerivation {
    ...
    xf86videovmware = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto
      ...
      stdenv.mkDerivation {
        ...
        nativeBuildInputs = [ pkgconfig ];
        buildInputs =
          [ xorgproto libdrm udev libpciaccess libX11 libXext xorgserver ];
        meta.platforms = stdenv.lib.platforms.unix;
      }) { };
    ...
    xfontsel = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, libXt }:
        stdenv.mkDerivation {
          name = "xfontsel-1.0.6";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xfs = callPackage
      ({ stdenv, pkgconfig, fetchurl, libXfont2, xorgproto, xtrans }:
        stdenv.mkDerivation {
          name = "xfs-1.2.0";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xfsinfo = callPackage ({ stdenv, pkgconfig, fetchurl, libFS, xorgproto }:
      stdenv.mkDerivation {
        name = "xfsinfo-1.0.6";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xgamma = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXxf86vm }:
        stdenv.mkDerivation {
          name = "xgamma-1.0.6";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xgc = callPackage ({ stdenv, pkgconfig, fetchurl, libXaw, libXt }:
      stdenv.mkDerivation {
        name = "xgc-1.0.5";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xhost = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libXau, libXmu, xorgproto }:
        stdenv.mkDerivation {
          name = "xhost-1.0.8";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xinit = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "xinit-1.4.1";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xkbcomp = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libxkbfile, xorgproto }:
        stdenv.mkDerivation {
          name = "xkbcomp-1.4.2";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xkbevd = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libxkbfile }:
      stdenv.mkDerivation {
        name = "xkbevd-1.1.4";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xkbutils = callPackage
      ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXaw, libXt }:
        stdenv.mkDerivation {
          name = "xkbutils-1.0.4";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xkeyboardconfig = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
        stdenv.mkDerivation {
    ...
    xkill = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libXmu, xorgproto }:
        stdenv.mkDerivation {
          name = "xkill-1.0.5";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xlsatoms = callPackage ({ stdenv, pkgconfig, fetchurl, libxcb }:
      stdenv.mkDerivation {
        name = "xlsatoms-1.1.3";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xlsclients = callPackage ({ stdenv, pkgconfig, fetchurl, libxcb }:
      stdenv.mkDerivation {
    ...
    xlsfonts = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "xlsfonts-1.0.6";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xmessage = callPackage ({ stdenv, pkgconfig, fetchurl, libXaw, libXt }:
      stdenv.mkDerivation {
        name = "xmessage-1.0.5";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xmodmap = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "xmodmap-1.0.10";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xmore = callPackage ({ stdenv, pkgconfig, fetchurl, libXaw, libXt }:
      stdenv.mkDerivation {
        name = "xmore-1.0.3";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xorgcffiles = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    xorgdocs = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    xorgproto = callPackage ({ stdenv, pkgconfig, fetchurl, libXt }:
      stdenv.mkDerivation {
    ...
    xorgserver = callPackage ({ stdenv, pkgconfig, fetchurl, xorgproto, openssl
      ...
      , xcbutilkeysyms, xcbutilrenderutil, libXdmcp, libXfixes, libxkbfile
      , libXmu, libXpm, libXrender, libXres, libXt }:
      stdenv.mkDerivation {
    ...
    xorgsgmldoctools = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
    ...
    xprop = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "xprop-1.2.4";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xrandr = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto
    ...
    xrefresh = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "xrefresh-1.0.6";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xsm = callPackage
      ({ stdenv, pkgconfig, fetchurl, libICE, libSM, libX11, libXaw, libXt }:
        stdenv.mkDerivation {
          name = "xsm-1.0.4";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xtrans = callPackage ({ stdenv, pkgconfig, fetchurl }:
      stdenv.mkDerivation {
        name = "xtrans-1.4.0";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xtrap = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXt }:
      stdenv.mkDerivation {
        name = "xtrap-1.0.3";
        builder = ./builder.sh;
        src = fetchurl {
    ...
    xvinfo = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXv }:
        stdenv.mkDerivation {
          name = "xvinfo-1.1.4";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xwd = callPackage
      ({ stdenv, pkgconfig, fetchurl, libxkbfile, libX11, xorgproto }:
        stdenv.mkDerivation {
          name = "xwd-1.0.7";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xwininfo = callPackage
      ({ stdenv, pkgconfig, fetchurl, libX11, libxcb, xorgproto }:
        stdenv.mkDerivation {
          name = "xwininfo-1.1.4";
          builder = ./builder.sh;
          src = fetchurl {
    ...
    xwud = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }:
      stdenv.mkDerivation {
        name = "xwud-1.0.5";
        builder = ./builder.sh;
        src = fetchurl {
