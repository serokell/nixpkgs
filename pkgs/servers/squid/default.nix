{ stdenv, fetchurl, perl, openldap, pam, db, cyrus_sasl, libcap, expat, libxml2, openssl, fetchpatch
}:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://github.com/squid-cache/squid/commit/5730c2b5cb56e7639dc423dd62651c8736a54e35.patch";
  ...
  ] ++ stdenv.lib.optional (stdenv.isLinux && !stdenv.hostPlatform.isMusl)
