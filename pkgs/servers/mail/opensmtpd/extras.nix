...
stdenv.mkDerivation rec {
  ...
  ] ++ stdenv.lib.optional enableRedis [ "--with-table-redis" ];

  NIX_CFLAGS_COMPILE =
    stdenv.lib.optional enableRedis "-I${hiredis}/include/hiredis -lhiredis"
    ++ stdenv.lib.optional enableMysql "-L${mysql.connector-c}/lib/mysql";
