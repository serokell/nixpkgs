...
in stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "http://git.openafs.org/?p=openafs.git;a=patch;h=b9936e944a2b4f5773d66864cbb297993b050e65";
      sha256 = "16fl9kp0l95dqm166jx3x4ijbzhf2bc9ilnipn3k1j00mfy4lnia";
    })
    (fetchpatch {
      name = "openafs_1_6-do_settimeofday.patch";
      url =
        "http://git.openafs.org/?p=openafs.git;a=patch;h=fe6fb38b3d4095351955b9872d0fd6cba64f8784";
    ...
    (fetchpatch {
      ...
      url =
        "http://git.openafs.org/?p=openafs.git;a=patch;h=61db15f1badabd83e289efd622e274c47f0aefda";
      sha256 = "0cdd76s1h1bhxj0hl7r6mcha1jcy5vhlvc5dc8m2i83a6281yjsa";
    })
  ];
  nativeBuildInputs = [ autoconf automake flex perl bison which ]
  ...
  meta = with stdenv.lib; {
    ...
    broken = versionOlder kernel.version "3.18"
      || builtins.compareVersions kernel.version "5.0" >= 0
