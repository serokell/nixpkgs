...
let # un-indented, over the whole file
  ...
  unwrapped = stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      ...
      sha256 =
        "2fe470f9bb1007667cdd448f758087244b7195a0234c2b100a9beeed0a2d3e68";
    };
    ...
    '' + stdenv.lib.optionalString doInstallCheck
      (exportLuaPathsFor [ lua.cqueues lua.basexx ]);
    ...
    doInstallCheck = with stdenv;
      hostPlatform == buildPlatform && !hostPlatform.isAarch64;
  ...
  # https://github.com/NixOS/nixpkgs/pull/63108#issuecomment-508670438
  wrapped-full = with stdenv.lib;
    with luajitPackages;
    let
      luaPkgs = [
        luasec
        luasocket # trust anchor bootstrap, prefill module
