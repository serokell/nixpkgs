...
let
  sources = {
    ...
    "chainpad-server-3.0.2" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/chainpad-server/-/chainpad-server-3.0.2.tgz";
        sha512 =
          "c5aEljVAapDKKs0+Rt2jymKAszm8X4ZeLFNJj1yxflwBqoh0jr8OANYvbfjtNaYFe2Wdflp/1i4gibYX4IMc+g==";
      };
    };
    ...
    "gar-1.0.4" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "w4n9cPWyP7aHxKxYHFQMegj7WIAsL/YX/C4Bs5Rr8s1H9M1rNtRWRsw+ovYMkXDQ5S4ZbYHsHAPmevPjPgw44w==";
      };
    };
    "get-folder-size-2.0.1" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/get-folder-size/-/get-folder-size-2.0.1.tgz";
        sha512 =
          "+CEb+GDCM7tkOS2wdMKTn9vU7DgnKUTuDlehkNJKNSovdCOVxs14OfKCk4cvSaR3za4gj+OBdl9opPN9xrJ0zA==";
      };
    };
    "graceful-fs-4.1.15" = {
      name = "graceful-fs";
    ...
    "nthen-0.1.8" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "Oh2CwIbhj+wUT94lQV7LKmmgw3UYAGGd8oLIqp6btQN3Bz3PuWp4BuvtUo35H3rqDknjPfKx5P6mt7v+aJNjcw==";
      };
    };
    "on-finished-2.3.0" = {
      name = "on-finished";
    ...
    "pull-stream-3.6.12" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "+LO1XIVyTMmeoH26UHznpgrgX2npTVYccTkMpgk/EyiQjFt1FmoNm+w+/zMLuz9U3bpvT5sSUicMKEe/2JjgEA==";
      };
    };
    "qs-6.5.2" = {
      name = "qs";
    ...
    "stream-to-pull-stream-1.7.3" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/stream-to-pull-stream/-/stream-to-pull-stream-1.7.3.tgz";
        sha512 =
          "6sNyqJpr5dIOQdgNy/xcDWwDuzAsAwVzhzrWlAPAQ7Lkjx/rv0wgvxEyKwTq6FmNd5rjTrELt/CLmaSw7crMGg==";
      };
    };
    "tiny-each-async-2.0.3" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/tiny-each-async/-/tiny-each-async-2.0.3.tgz";
...
in {
  "cryptpad-git+https://github.com/xwiki-labs/cryptpad.git#2.23.0" =
    nodeEnv.buildNodePackage {
      ...
      src = fetchgit {
        ...
        sha256 =
          "a094708e4a275ee55ca3a59a2890f20f2f9f7dcfe50274b7e3ecd260502c583b";
      };
      dependencies = [
        ...
        sources."vary-1.1.2"
        (sources."ws-1.1.5" // { dependencies = [ sources."ultron-1.0.2" ]; })
      ];
