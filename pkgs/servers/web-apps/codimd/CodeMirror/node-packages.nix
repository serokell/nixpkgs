...
let
  sources = {
    ...
    "acorn-object-spread-1.0.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/acorn-object-spread/-/acorn-object-spread-1.0.0.tgz";
    ...
    "estree-walker-0.2.1" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/estree-walker/-/estree-walker-0.2.1.tgz";
    ...
    "magic-string-0.14.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/magic-string/-/magic-string-0.14.0.tgz";
    ...
    "rollup-pluginutils-1.5.2" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/rollup-pluginutils/-/rollup-pluginutils-1.5.2.tgz";
    ...
    "vlq-0.2.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "DRibZL6DsNhIgYQ+wNdWDL2SL3bKPlVrRiBqV5yuMm++op8W4kGFtaQfCs4KEJn0wBZcHVHJ3eoywX8983k1ow==";
      };
    };
    "which-1.3.1" = {
      name = "which";
...
in {
  ...
  "rollup-plugin-buble-^0.15.0" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/rollup-plugin-buble/-/rollup-plugin-buble-0.15.0.tgz";
  ...
  "rollup-watch-^3.2.0" = nodeEnv.buildNodePackage {
    ...
    dependencies = [ sources."require-relative-0.8.7" ];
    buildInputs = globalBuildInputs;
    meta = {
      description =
