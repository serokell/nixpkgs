{ stdenv, fetchurl, makeWrapper, libzen, libmediainfo, jre8 }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "mirror://sourceforge/project/unimediaserver/Official%20Releases/Linux/"
      + stdenv.lib.toUpper "${name}" + "-Java8.tgz";
