...
let
  ...
  python3-six-patch = fetchpatch {
    ...
    url =
      "https://github.com/apple/foundationdb/commit/4bd9efc4fc74917bc04b07a84eb065070ea7edb2.patch";
  ...
  python3-print-patch = fetchpatch {
    ...
    url =
      "https://github.com/apple/foundationdb/commit/ded17c6cd667f39699cf663c0e87fe01e996c153.patch";
...
in with builtins; {
  ...
  foundationdb60 = vsmakeBuild rec {
    ...
    patches = [ ./patches/ldflags-6.0.patch ];
  };
  ...
  foundationdb61 = cmakeBuild rec {
    ...
    patches =
      [ ./patches/clang-libcxx.patch ./patches/suppress-clang-warnings.patch ];
  };
