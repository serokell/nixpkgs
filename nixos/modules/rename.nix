...

{
  imports = [
    ...
    (mkRenamedOptionModule [ "services" "kubernetes" "apiserver" "port" ] [
      "services"
      "kubernetes"
      "apiserver"
      "insecurePort"
    ...
    (mkRenamedOptionModule [ "services" "clamav" "updater" "config" ] [
      "services"
      "clamav"
      "updater"
      "extraConfig"
    ...
    (mkRenamedOptionModule [ "boot" "loader" "grub" "timeout" ] [
      "boot"
      "loader"
      "timeout"
    ])
    (mkRenamedOptionModule [ "boot" "loader" "gummiboot" "timeout" ] [
      "boot"
      "loader"
      "timeout"
    ])
    ...
    (mkRenamedOptionModule [ "services" "piwik" "phpfpmProcessManagerConfig" ] [
      "services"
      "matomo"
    ...
    # zabbixServer
    (mkRenamedOptionModule [ "services" "zabbixServer" "dbServer" ] [
      "services"
      "zabbixServer"
      "database"
      "host"
    ...
    (mkRenamedOptionModule [ "programs" "zsh" "syntax-highlighting" "enable" ] [
      "programs"
      "zsh"
      "syntaxHighlighting"
      "enable"
    ...
    # binfmt
    (mkRenamedOptionModule [ "boot" "binfmtMiscRegistrations" ] [
      "boot"
      "binfmt"
      "registrations"
    ])
    ...
    mkRemovedOptionModule [ "services" "prometheus" "${opt}" ] ''
