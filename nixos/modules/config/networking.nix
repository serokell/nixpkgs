...
let
  ...
  localhostMapped4 = cfg.hosts ? "127.0.0.1"
    && elem "localhost" cfg.hosts."127.0.0.1";
...
in {
  ...
  config = {
    ...
    networking.hosts = {
      "127.0.0.1" = [ "localhost" ];
    } // optionalAttrs (cfg.hostName != "") { "127.0.1.1" = [ cfg.hostName ]; }
      // optionalAttrs cfg.enableIPv6 { "::1" = [ "localhost" ]; };
