    ...
    in {
      ...
      options = {
        ...
        logFailures = mkOption {
          ...
          type = types.bool;
          description =
            "Whether to log authentication failures in <filename>/var/log/faillog</filename>.";
        };
      ...
      config = {
        ...
        text = mkDefault (''
          ...
          ${optionalString cfg.rootOK "auth sufficient pam_rootok.so"}
          ${optionalString cfg.requireWheel
          "auth required pam_wheel.so use_uid"}
          ${optionalString cfg.logFailures "auth required pam_tally.so"}
          ${optionalString
          ...
          "auth requisite ${pkgs.oathToolkit}/lib/security/pam_oath.so window=${
          ...
          "auth ${yubi.control} ${pkgs.yubico-pam}/lib/security/pam_yubico.so id=${
            toString yubi.id
