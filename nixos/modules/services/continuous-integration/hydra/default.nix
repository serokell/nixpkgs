...
in {
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.hydra-queue-runner = {
      ...
      serviceConfig = {
        ExecStart =
          "@${cfg.package}/bin/hydra-queue-runner hydra-queue-runner -v --option build-use-substitutes ${
            boolToString cfg.useSubstitutes
          }";
    ...
    systemd.services.hydra-update-gc-roots = {
      ...
      serviceConfig = {
        ExecStart =
          "@${cfg.package}/bin/hydra-update-gc-roots hydra-update-gc-roots";
        User = "hydra";
      };
      startAt = "2,14:15";
    };
