...
in {
  ...
  config = mkIf cfg.enable {
    ...
    environment.etc."fail2ban/action.d".source =
      "${pkgs.fail2ban}/etc/fail2ban/action.d/*.conf";
    environment.etc."fail2ban/filter.d".source =
      "${pkgs.fail2ban}/etc/fail2ban/filter.d/*.conf";
