...
let
  ...
  configMgmtd = name: cfg:
    pkgs.writeText "mgmt-${name}.conf" ''
  ...
  configAdmon = name: cfg:
    pkgs.writeText "admon-${name}.conf" ''
  ...
  configStorage = name: cfg:
    pkgs.writeText "storage-${name}.conf" ''
  ...
  configHelperd = name: cfg:
    pkgs.writeText "helperd-${name}.conf" ''
      connAuthFile = ${cfg.connAuthFile}
...
in {
  ...
  config = mkIf config.services.beegfsEnable {
