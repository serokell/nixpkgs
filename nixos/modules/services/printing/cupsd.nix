...
let
  ...
  filterGutenprint = pkgs:
    filter (pkg: pkg.meta.isGutenprint or false == true) pkgs;
...
in {
    ...
    services.printing = {
      ...
      drivers = mkOption {
        ...
        example = literalExample
          "with pkgs; [ gutenprint hplip splix cups-googlecloudprint ]";
        description = ''
  ...
  config = mkIf config.services.printing.enable {
    ...
    environment.systemPackages = [ cups.out ]
