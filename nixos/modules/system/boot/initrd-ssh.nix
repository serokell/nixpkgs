...
in {
  ...
  config = mkIf (config.boot.initrd.network.enable && cfg.enable) {
    ...
    boot.initrd.secrets = (optionalAttrs (cfg.hostRSAKey != null) {
      "/etc/dropbear/dropbear_rsa_host_key" = cfg.hostRSAKey;
    }) // (optionalAttrs (cfg.hostDSSKey != null) {
      "/etc/dropbear/dropbear_dss_host_key" = cfg.hostDSSKey;
    }) // (optionalAttrs (cfg.hostECDSAKey != null) {
      "/etc/dropbear/dropbear_ecdsa_host_key" = cfg.hostECDSAKey;
    });
