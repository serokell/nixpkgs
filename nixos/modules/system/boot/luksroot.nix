...
let
  ...
  openCommand = name':
    ...
    in ''
      ...
      || (luks.gpgSupport && (gpgCard != null)) then ''
        open_with_hardware
      '' else ''
        open_normally
      ''}
        ...
        loaOf (submodule ({ name, ... }: {
          options = {
            ...
            name = mkOption {
              ...
              type = types.str;
              description =
                "Name of the unencrypted device in <filename>/dev/mapper</filename>.";
            };
  ...
  config = mkIf (luks.devices != { } || luks.forceLuksSupportInInitrd) {
    ...
    boot.initrd.extraUtilsCommands = ''
      ...
      ${optionalString luks.yubikeySupport ''
        ...
        cc -O3 -I${pkgs.openssl.dev}/include -L${pkgs.openssl.out}/lib ${
          ./pbkdf2-sha512.c
    ...
    boot.initrd.preLVMCommands = commonFunctions + preCommands
      + concatStrings (mapAttrsToList openCommand preLVM) + postCommands;
    boot.initrd.postDeviceCommands = commonFunctions + preCommands
